<?php
    ...
    class Geo
    {
         ...
         *               Если true, то в куки будут записаны данные по ip и повторные запросы на ipgeobase происходить
         *               не будут. Если false, то данные постоянно будут запрашиваться с ipgeobase
         *
         * @return array OR string - дополнительно читайте комментарии внутри функции.
         */
        function get_value($key = null, $cookie = false)
        {
        ...
        function get_ip()
        {
            $keys = array('REMOTE_ADDR', 'HTTP_X_FORWARDED_FOR', 'HTTP_CLIENT_IP', 'HTTP_X_REAL_IP');
            foreach ($keys as $key) {
