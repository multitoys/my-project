...
//----------- Импорт товаров ----------- 
  ...
  $row = 0;
  $percent = 0;
  $replace_pcode = array('Техно ', 'ПЦ ', 'BANBAO ', 'DEFA ', 'JIXIN ', 'JT ', 'PS ', 'T ', 'Дiв ', 'Збр ', 'Звi ', 'КВ ', 'Кон ', 'Лял ', 'Маш ', 'Муз ', 'Мяк ', 'Мяч ', 'Нас ', 'Нем ', 'ОР ', 'Різ ', 'Ст ', 'Хло ', 'ЮН ', 'ЯБ ');
  $replace_name = array('\'', '"');
  if (($handle = fopen($filename, 'r')) !== FALSE) {
    ...
    while (($data = fgetcsv($handle, 1000, ';')) !== FALSE) {
        ...
        $product_code = mysql_real_escape_string(str_replace($replace_pcode, '', DecodeCodepage1251($data[3])));
