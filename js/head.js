var mainScroll, listScroll, searchCache = [];
...
$(document).ready(function () {
    var notProgress = true, content = $("#content"), scrollPane = $(".scroll-pane1"), preview = $(".preview")/*, controls = $(".controls")*//*, quantity = $(".cart_product_quantity")*/, cuttedPath;
    $("#slidemenu1").multiSlideMenu({
        ...
        afterLoadDone: function () {
            ...
            // $("li.cl-effect-21").find("a").click(navigation);
        }
    });
    ...
    switch (cuttedPath[1]) {
        case"cart":
            try {
                $("#slidemenu0").toggleClass("hide").multiSlideMenu({
                    autoHeightMenu: true,
                    backOnTop: false,
    ...
    if (!strpos(window.navigator.userAgent, 'Mac OS X')) {
