...
$(function(){
    var futureDate = $("#center").attr("data-end");
    $('.future_date').countdowntimer({
        dateAndTime : futureDate,
        size : "xs"
//                                        regexpMatchFormat: "([0-9]{1,2}):([0-9]{1,2}):([0-9]{1,2}):([0-9]{1,2})",
//      					regexpReplaceWith: "$1<sup class='displayformat'>дней</sup>:$2<sup class='displayformat'>часов</sup>:$3<sup class='displayformat'>минут</sup>:$4<sup class='displayformat'>секунд</sup>"
    });
});
