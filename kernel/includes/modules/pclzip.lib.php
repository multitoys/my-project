            ...
            if ($v_size > 0) {
                ...
                if ((is_integer($v_arg_list[0])) && ($v_arg_list[0] > 77000)) {
                    ...
                    if (isset($v_options[PCLZIP_OPT_ADD_PATH])) {
                        ...
                        if ((mb_strlen($v_path, "ISO-8859-1") > 0) && (substr($v_path, -1) != '/')) {
                            $v_path .= '/';
                        }
...
//          || (   is_dir($p_filedescr_list[$j]['filename'])
    ...
    */
            ...
            $p_header['filename_len'] = mb_strlen($p_filename, "ISO-8859-1");
...
// TBC : Removed    $p_header['stored_filename'] = $v_stored_filename;
            ...
            if ($p_filedescr['type'] == 'file') {
                ...
                $p_header['external'] = 0x00000000;
                $p_header['size'] = mb_strlen($p_filedescr['content'], "ISO-8859-1");
            }
            ...
            if (isset($p_filedescr['comment'])) {
                $p_header['comment_len'] = mb_strlen($p_filedescr['comment'], "ISO-8859-1");
            ...
            if (mb_strlen($p_header['stored_filename'], "ISO-8859-1") > 0xFF) {
...
//      if (is_file($p_filename))
                if (($p_filedescr['type'] == 'file')
                    ...
                    if ($p_options[PCLZIP_OPT_NO_COMPRESSION]) {
                        ...
                        // ----- Set header parameters
                        $p_header['compressed_size'] = mb_strlen($v_content, "ISO-8859-1");
        ...
        if ((isset($p_options[PCLZIP_OPT_CRYPT]))
          ...
          //--(MAGIC-PclTrace)--//PclTraceFctMessage(__FILE__, __LINE__, 2, "Size after header : ".mb_strlen($v_content_compressed)."");
        }
        */
        ...
        function privCalculateStoredFilename(&$p_filedescr, &$p_options)
        {
                    ...
                    if ($v_compare > 0) {
                        if ($v_compare == 2) {
                            ...
                            $v_stored_filename = substr($v_stored_filename,
                                mb_strlen($p_remove_dir, "ISO-8859-1"));
            ...
            //--(MAGIC-PclTrace)--//PclTraceFctMessage(__FILE__, __LINE__, 2, "Stored filename will be '".$p_filedescr['stored_filename']."', mb_strlen ".mb_strlen($p_filedescr['stored_filename']));
        ...
        function privWriteFileHeader(&$p_header)
        {
            ...
            $v_binary_data = pack("VvvvvvVVVvv", 0x04034b50,
                ...
                $p_header['size'],
                mb_strlen($p_header['stored_filename'], "ISO-8859-1"),
                $p_header['extra_len']);
            ...
            if (mb_strlen($p_header['stored_filename'], "ISO-8859-1") != 0) {
                fputs($this->zip_fd, $p_header['stored_filename'], mb_strlen($p_header['stored_filename'], "ISO-8859-1"));
            }
        ...
        function privWriteCentralHeader($p_nb_entries, $p_size, $p_offset, $p_comment)
        {
            ...
            $v_binary_data = pack("VvvvvVVv", 0x06054b50, 0, 0, $p_nb_entries,
                $p_nb_entries, $p_size,
                $p_offset, mb_strlen($p_comment, "ISO-8859-1"));

            // ----- Write the 22 bytes of the header in the zip file
            fputs($this->zip_fd, $v_binary_data, 22);

            // ----- Write the variable fields
            if (mb_strlen($p_comment, "ISO-8859-1") != 0) {
                fputs($this->zip_fd, $p_comment, mb_strlen($p_comment, "ISO-8859-1"));
            }
        ...
        function privExtractByRule(&$p_file_list, $p_path, $p_remove_path, $p_remove_all_path, &$p_options)
        {
            ...
            if (($p_path != "./") && ($p_path != "/")) {
                ...
                while (substr($p_path, -1) == "/") {
                    ...
                    $p_path = substr($p_path, 0, mb_strlen($p_path, "ISO-8859-1") - 1);
            ...
            $p_remove_path_size = mb_strlen($p_remove_path, "ISO-8859-1");
                ...
                if ((isset($p_options[PCLZIP_OPT_BY_NAME]))
                    ...
                    for ($j = 0; ($j < sizeof($p_options[PCLZIP_OPT_BY_NAME])) && (!$v_extract); $j++) {
                        ...
                        if (substr($p_options[PCLZIP_OPT_BY_NAME][$j], -1) == "/") {
                            ...
                            if ((mb_strlen($v_header['stored_filename'], "ISO-8859-1") > mb_strlen($p_options[PCLZIP_OPT_BY_NAME][$j], "ISO-8859-1"))
                                && (substr($v_header['stored_filename'], 0, mb_strlen($p_options[PCLZIP_OPT_BY_NAME][$j], "ISO-8859-1")) == $p_options[PCLZIP_OPT_BY_NAME][$j])
                            ) {
...
//      if ($p_entry['compressed_size'] == $p_entry['size'])
        ...
        function privReadEndCentralDir(&$p_central_dir)
        {
            ...
            if (mb_strlen($v_binary_data, "ISO-8859-1") != 18) {
                //--(MAGIC-PclTrace)--//PclTraceFctMessage(__FILE__, __LINE__, 2, "Invalid End of Central Dir Record size : ".mb_strlen($v_binary_data));
                ...
                if ((isset($p_options[PCLZIP_OPT_BY_NAME]))
                    ...
                    for ($j = 0; ($j < sizeof($p_options[PCLZIP_OPT_BY_NAME])) && (!$v_found); $j++) {
                        ...
                        if (substr($p_options[PCLZIP_OPT_BY_NAME][$j], -1) == "/") {
                            ...
                            // ----- Look if the directory is in the filename path
                            if ((mb_strlen($v_header_list[$v_nb_extracted]['stored_filename'], "ISO-8859-1") > mb_strlen($p_options[PCLZIP_OPT_BY_NAME][$j]))
                                && (substr($v_header_list[$v_nb_extracted]['stored_filename'], 0, mb_strlen($p_options[PCLZIP_OPT_BY_NAME][$j], "ISO-8859-1")) == $p_options[PCLZIP_OPT_BY_NAME][$j])
                            ) {
                                //--(MAGIC-PclTrace)--//PclTraceFctMessage(__FILE__, __LINE__, 3, "The directory is in the file path");
                                $v_found = true;
        ...
        function privDirCheck($p_dir, $p_is_dir = false)
        {
            ...
            if (($p_is_dir) && (substr($p_dir, -1) == '/')) {
                $p_dir = substr($p_dir, 0, mb_strlen($p_dir, "ISO-8859-1") - 1);
            }
