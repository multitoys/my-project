...
// +---------------------------------------------------------------------+
//
// $Id: Container.php,v 1.28 2003/09/21 17:53:14 mansion Exp $
    ...
    class Config_Container
    {
         ...
         * @param  int    $index      Index of the item in the returned object list. If it is not set, will try to
         *                            return the last item with this name.
         *
