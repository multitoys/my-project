<?php
    ...
    // +------------------------------------------------------------------------+
    //
    // $Id: TestSuite.php,v 1.6 2003/08/28 11:32:04 sebastian Exp $
    //
    ...
    class PHPUnit_Framework_TestSuite implements PHPUnit_Framework_Test
    {
        ...
        public function __construct($theClass = '', $name = '')
        {
            ...
            try {
                $this->getTestConstructor($theClass);
            } catch (Exception $e) {
                $this->addTest(
                    self::warning(
                        sprintf(
        ...
        // }}}
        // {{{ public static function getTestConstructor(Reflection_Class $theClass)
        ...
        private function isPublicTestMethod(Reflection_Method $method)
        {
            return ($this->isTestMethod($method) /*&&
                Reflection_Modifier::isPublic($method->getModifiers())*/);
        }
