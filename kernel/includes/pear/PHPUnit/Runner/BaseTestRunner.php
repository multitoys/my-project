<?php
    ...
    // +------------------------------------------------------------------------+
    //
    // $Id: BaseTestRunner.php,v 1.6 2003/08/28 12:05:17 sebastian Exp $
    //
    ...
    abstract class PHPUnit_Runner_BaseTestRunner implements PHPUnit_Framework_TestListener
    {
        ...
        public function getTest($suiteClassName)
        {
            ...
            if ($suiteMethod) {
                die('XXX: FIX ME: Implement suite method handling.');
            } else {
                $this->clearStatus();

                return new PHPUnit_Framework_TestSuite($testClass, $suiteClassName);
            }
        }
