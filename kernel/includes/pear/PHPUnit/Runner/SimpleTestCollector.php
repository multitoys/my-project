<?php
    ...
    // +------------------------------------------------------------------------+
    //
    // $Id: SimpleTestCollector.php,v 1.1 2003/07/25 05:01:45 sebastian Exp $
    //

    require_once 'PHPUnit/Runner/ClassPathTestCollector.php';
     ...
     */
    class PHPUnit_Runner_SimpleTestCollector extends PHPUnit_Runner_ClassPathTestCollector
    {
