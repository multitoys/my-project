<?php
     ...
     */
    define('PAYPAL_WSDL_VERSION', 2.1);
     ...
     * error handling, etc.
     *
     * $Id: CallerServices.php,v 1.2 2005/10/19 22:18:09 colson Exp $
     *
     * @package Services_PayPal
     */
    class CallerServices extends SOAP_Client
    {
         ...
         *   PEAR_LOG_INFO  - (default) Date/time of operation, operation name, elapsed time, success or failure
         *   indication. PEAR_LOG_DEBUG - Full text of SOAP requests and responses and other debugging messages.
         *
