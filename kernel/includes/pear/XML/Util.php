...
// +----------------------------------------------------------------------+
//
//    $Id: Util.php,v 1.10 2003/09/23 08:10:29 schst Exp $
    ...
    class XML_Util
    {
         ...
         *
         * // create an XML tag:
         * $tag = XML_Util::createTag("myNs:myTag", array("foo" => "bar"), "This is inside the tag",
         ...
         * @param    integer $replaceEntities whether to replace XML special chars in content, embedd it in a CData
         *                                    section or none of both
         * @param    boolean $multiline       whether to create a multiline tag where each attribute gets written to a
         *                                    single line
         * @param    string  $indent          string used to indent attributes (_auto indents attributes so they start
         *                                    at the same column)
         ...
         * @param    boolean $multiline    whether to create a multiline tag where each attribute gets written to a
         *                                 single line
         * @param    string  $indent       string used to indent attributes (_auto indents attributes so they start at
         *                                 the same column)
         * @param    string  $linebreak    string used for linebreaks
         *
        ...
        function isValidName($string)
        {
            ...
            if (!preg_match("/^[[:alnum:]_\-.]+$/u", $string)) {
            ...
            if (!preg_match("/[[:alpha:]_]/u", $string{0})) {
