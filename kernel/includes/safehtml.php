<?php
     ...
     * @licensehttp://www.debian.org/misc/bsd.license  BSD License (3 Clause)
     * @versionCVS : $Id:$
    ...
    class SafeHTML
    {
         ...
         * @access public
         */
        var $blackProtocols = array('about', 'chrome', 'data', 'disk', 'hcp', 'help', 'javascript', 'livescript', 'lynxcgi', 'lynxexec',
            'ms-help', 'ms-its', 'mhtml', 'mocha', 'opera', 'res', 'resource', 'shell', 'vbscript', 'view-source', 'vnd.ms.radio', 'wysiwyg'
        );
         ...
         * @access public
         */
        var $whiteProtocols = array('ed2k', 'file', 'ftp', 'gopher', 'http', 'https', 'mailto', 'news', 'nntp', 'telnet', 'webcal');
         ...
         * @access public
         */
        var $protocolAttributes = array('action', 'background', 'codebase', 'dynsrc', 'href', 'lowsrc', 'src');
         ...
         * @access public
         */
        var $cssKeywords = array('absolute', 'behavior', 'behaviour', 'content', 'expression', 'fixed', 'include-source', 'moz-binding');
        ...
        function _writeAttrs($attrs)
        {
            ...
            if (is_array($attrs)) {
                foreach ($attrs as $name => $value) {
                    ...
                    $tempval = preg_replace('/&#(\d+);?/ume', "chr('\\1')", $value); //"'
                    $tempval = preg_replace('/&#x([0-9a-f]+);?/meui', "chr(hexdec('\\1'))", $tempval);
