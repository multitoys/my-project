<?php
    ...
    class Smarty_Compiler extends Smarty
    {
        ...
        function _compile_tag($template_tag)
        {
            ...
            //modification for SC
            if (strpos($tag_command, 'lbl_') === 0) {

                $tag_command = "'".substr($tag_command, 4)."'";
                $tag_modifier = '|translate';
            }

            //modification for SC
            if (strpos($tag_command, 'cpt_') === 0) {

                $tag_args = "cpt_id='".substr($tag_command, 4)."' {$tag_args}";
                $tag_command = "component";
            }
