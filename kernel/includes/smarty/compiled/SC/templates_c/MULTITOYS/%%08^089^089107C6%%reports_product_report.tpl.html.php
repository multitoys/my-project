<?php /* Smarty version 2.6.9, created on 2015-09-27 17:45:02
...
"><?php echo $this->_tpl_vars['GridRows'][$this->_sections['i']['index']]['in_stock'];  if ($this->_tpl_vars['GridRows'][$this->_sections['i']['index']]['in_stock'] <= 0 && @CONF_CHECKSTOCK): ?>*<?php endif; ?>&nbsp;</a></td>
		<td width="10%" align="right"><a href="<?php echo $this->_tpl_vars['product_url']; ?>
...
&nbsp;<?php if (! $this->_tpl_vars['GridRows'][$this->_sections['i']['index']]['ordering_available']): ?><div class="notice"><?php echo ((is_array($_tmp='prd_ordering_not_available')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</div><?php endif; ?></a></td>
		<td width="10%" align="right"><a href="<?php echo $this->_tpl_vars['product_url']; ?>
...
<p class="field_descr gridline_outofstock">* <?php echo ((is_array($_tmp='srep_outofstock')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</p>
<?php endif; ?>