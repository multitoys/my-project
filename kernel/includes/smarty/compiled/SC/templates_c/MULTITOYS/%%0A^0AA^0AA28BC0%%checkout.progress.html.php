...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'checkout.progress.html', 5, false),array('modifier', 'set_query_html', 'checkout.progress.html', 7, false),array('modifier', 'translate', 'checkout.progress.html', 7, false),array('modifier', 'transcape', 'checkout.progress.html', 17, false),)), $this); ?>
...
'><?php echo ((is_array($_tmp='goto_storefront')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</a></div>
		<?php endif; ?>
	</td>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['_chain_link']['title'])) ? $this->_run_mod_handler('transcape', true, $_tmp) : smarty_modifier_transcape($_tmp)); ?>
			...
			<?php else:  echo ((is_array($_tmp=$this->_tpl_vars['_chain_link']['title'])) ? $this->_run_mod_handler('transcape', true, $_tmp) : smarty_modifier_transcape($_tmp));  endif; ?>
			</td>
			<?php if (! ($this->_foreach['_frchain']['iteration'] == $this->_foreach['_frchain']['total'])): ?>
			<td></td>
			<?php endif; ?>
