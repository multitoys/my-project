...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'backend/order_detailed.html', 14, false),array('modifier', 'translate', 'backend/order_detailed.html', 17, false),array('modifier', 'set_query', 'backend/order_detailed.html', 21, false),array('modifier', 'transcape', 'backend/order_detailed.html', 44, false),array('modifier', 'set_query_html', 'backend/order_detailed.html', 44, false),array('modifier', 'replace', 'backend/order_detailed.html', 73, false),array('modifier', 'cat', 'backend/order_detailed.html', 94, false),array('modifier', 'lower', 'backend/order_detailed.html', 105, false),array('modifier', 'string_format', 'backend/order_detailed.html', 278, false),array('modifier', 'nl2br', 'backend/order_detailed.html', 282, false),array('function', 'cycle', 'backend/order_detailed.html', 264, false),)), $this); ?>
...
'><?php echo ((is_array($_tmp='ordr_order_list')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</a>
	&raquo;
...
"><?php echo $this->_tpl_vars['order']['status_name']; ?>
	...
	&nbsp;
	<input value="<?php echo ((is_array($_tmp='btn_open_invoice')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
...
' type="button" class="new_window" wnd_width='700' wnd_height='500' />
	...
	<p>
		<?php echo ((is_array($_tmp='ordr_order_time')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
 <?php echo $this->_tpl_vars['order']['order_time']; ?>
 (<?php echo ((is_array($_tmp='ordr_customer_ip')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
...
' type="button" class="goto <?php if ($this->_tpl_vars['_action']['confirm']):  echo $this->_tpl_vars['_action']['confirm'];  endif; ?>" title="<?php echo ((is_array($_tmp=$this->_tpl_vars['_action']['confirm'])) ? $this->_run_mod_handler('transcape', true, $_tmp) : smarty_modifier_transcape($_tmp)); ?>
...
;font-weight:bold;" onpreclick="obj=document.getElementById('change_status_comment');obj2=document.getElementById('notify_customer');if(obj&&obj2&&obj2.checked)this.setAttribute('rel',this.getAttribute('rel_source')+'&amp;status_comments='+obj.value+'&amp;notify_customer=1');"/>
                    ...
                    <td>
                	<input value="<?php echo ((is_array($_tmp='ordr_change_status')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
...
">
                    	<label><input id="notify_customer" type="checkbox" onchange="JavaScript:obj=document.getElementById('change_status_comment_cnt');if(obj)obj.style.display=this.checked?'block':'none';"><?php echo ((is_array($_tmp='ordr_send_buyer_message')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</label>
                    	<div id="change_status_comment_cnt" style="display:none;margin-left:10px;">
                    	<?php echo ((is_array($_tmp='ordr_add_comment_to_message')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
<br>
            ...
            <td style="padding-left: 20px;padding-top: 20px;" valign="top">
              	<input value="<?php echo ((is_array($_tmp='btn_add_note')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
...
"><?php echo ((is_array($_tmp='lbl_edit_details')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</a>
                <?php endif; ?>
            </td>
        </tr>
...
<tr>
<td><h3><?php echo ((is_array($_tmp='ordr_custinfo')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</h3></td>
<td><h3><?php echo ((is_array($_tmp='print_forms')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</h3></td>
</tr>
<tr>
<td valign="top">
...
<tr>
    <td valign="top" style="padding: 2px;"><?php echo ((is_array($_tmp='ordr_customer')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
:</td>
...
</strong><?php else:  echo ((is_array($_tmp='lbl_n_a')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp));  endif; ?>)</span>
        <br />
        <?php if (@CONF_BACKEND_SAFEMODE == 0):  echo ((is_array($_tmp='usr_custinfo_email')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
...
</a>,&nbsp;<?php else: ?><b><?php echo ((is_array($_tmp='msg_safemode_info_blocked')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</b><?php endif; ?>
...
<tr>
	<td valign="top" style="padding: 2px;"><?php echo ((is_array($_tmp='ordr_comment')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
:</td>
...
<?php endif; ?>
<tr>
	<td style="padding: 2px;"><?php echo ((is_array($_tmp='ordr_source')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
:</td>
...
"><?php echo $this->_tpl_vars['print_form']['name']; ?>
			...
			<tr><td colspan="2" align="left"><input id="printforms" onclick="show_printforms();" type="button" value="<?php echo ((is_array($_tmp='btn_print')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
"></td></tr>
		</table>
		</form>
<script type="text/javascript">
...
<tr>
<td><h3><?php echo ((is_array($_tmp='shipping')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
 &mdash; <?php echo ((is_array($_tmp=$this->_tpl_vars['order']['shipping_type'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html'));  if ($this->_tpl_vars['order']['shippingServiceInfo']): ?> (<?php echo ((is_array($_tmp=$this->_tpl_vars['order']['shippingServiceInfo'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
)<?php endif; ?></h3></td>
<td><h3><?php echo ((is_array($_tmp='payment')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
...
<tr>
	<td style="padding-right: 15px;" valign="top">
		...
		<?php echo ((is_array($_tmp='ordr_recipient')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
: <?php echo ((is_array($_tmp=$this->_tpl_vars['order']['shipping_firstname'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
 <?php echo ((is_array($_tmp=$this->_tpl_vars['order']['shipping_lastname'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
		...
		<br />
		<?php if ($this->_tpl_vars['order']['shipping_address'] != ""):  echo ((is_array($_tmp=$this->_tpl_vars['order']['shipping_address'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
<br /><?php endif; ?>
		<?php if ($this->_tpl_vars['order']['shipping_city'] != ""):  echo ((is_array($_tmp=$this->_tpl_vars['order']['shipping_city'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html'));  endif; ?>
		<?php if ($this->_tpl_vars['order']['shipping_state'] != ""):  echo ((is_array($_tmp=$this->_tpl_vars['order']['shipping_state'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html'));  endif; ?>
		<?php if ($this->_tpl_vars['order']['shipping_zip'] != ""):  echo ((is_array($_tmp=$this->_tpl_vars['order']['shipping_zip'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
<br /><?php endif; ?>
		<?php if ($this->_tpl_vars['order']['shipping_country'] != ""):  echo ((is_array($_tmp=$this->_tpl_vars['order']['shipping_country'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html'));  endif; ?>
        <?php if (! ( $this->_tpl_vars['order']['shipping_address'] == '' && $this->_tpl_vars['order']['shipping_city'] == '' )): ?>
        <br />
            <a href="javascript: void(0);" id="sa_lookup" style="font-size: 90%"><?php echo ((is_array($_tmp='lbl_lookup')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</a>
        <?php endif; ?>
	</td>
	<td style="padding-right: 15px;" valign="top">
		...
		<?php echo ((is_array($_tmp='ordr_payee')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
: <?php echo ((is_array($_tmp=$this->_tpl_vars['order']['billing_firstname'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
 <?php echo ((is_array($_tmp=$this->_tpl_vars['order']['billing_lastname'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
		...
		<br />
		<?php if ($this->_tpl_vars['order']['billing_address'] != ""):  echo ((is_array($_tmp=$this->_tpl_vars['order']['billing_address'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
<br /><?php endif; ?>
		<?php if ($this->_tpl_vars['order']['billing_city'] != ""):  echo ((is_array($_tmp=$this->_tpl_vars['order']['billing_city'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html'));  endif; ?>
		<?php if ($this->_tpl_vars['order']['billing_state'] != ""):  echo ((is_array($_tmp=$this->_tpl_vars['order']['billing_state'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html'));  endif; ?>
		<?php if ($this->_tpl_vars['order']['billing_zip'] != ""):  echo ((is_array($_tmp=$this->_tpl_vars['order']['billing_zip'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
<br /><?php endif; ?>
		<?php if ($this->_tpl_vars['order']['billing_country'] != ""):  echo ((is_array($_tmp=$this->_tpl_vars['order']['billing_country'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html'));  endif; ?>
        <?php if (! ( $this->_tpl_vars['order']['billing_address'] == '' && $this->_tpl_vars['order']['billing_city'] == '' )): ?>
        <br />
            <a href="javascript: void(0);" id="ba_lookup" style="font-size: 90%"><?php echo ((is_array($_tmp='lbl_lookup')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</a>
		<?php endif; ?>
		...
		<p>
			<strong><?php echo ((is_array($_tmp='ordr_ccinfo')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</strong>
			<br />

			<?php if (true): ?>				<table>
				<tr>
					<td><?php echo ((is_array($_tmp='ordr_ccnumber')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
: <b><?php echo ((is_array($_tmp=$this->_tpl_vars['order']['cc_number'])) ? $this->_run_mod_handler('replace', true, $_tmp, "<", "&lt;") : smarty_modifier_replace($_tmp, "<", "&lt;")); ?>
				...
				<tr>
					<td><?php echo ((is_array($_tmp='ordr_ccholdername')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
: <b><?php echo ((is_array($_tmp=$this->_tpl_vars['order']['cc_holdername'])) ? $this->_run_mod_handler('replace', true, $_tmp, "<", "&lt;") : smarty_modifier_replace($_tmp, "<", "&lt;")); ?>
				...
				<tr>
					<td><?php echo ((is_array($_tmp='ordr_ccexpires')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
: <b><?php echo ((is_array($_tmp=$this->_tpl_vars['order']['cc_expires'])) ? $this->_run_mod_handler('replace', true, $_tmp, "<", "&lt;") : smarty_modifier_replace($_tmp, "<", "&lt;")); ?>
				...
				<tr>
					<td><?php echo ((is_array($_tmp='ordr_cccvv')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
: <b><?php echo ((is_array($_tmp=$this->_tpl_vars['order']['cc_cvv'])) ? $this->_run_mod_handler('replace', true, $_tmp, "<", "&lt;") : smarty_modifier_replace($_tmp, "<", "&lt;")); ?>
			...
			<?php echo ((is_array($_tmp='ordr_ccinfo_shown_only_in_https')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
...
<tr class="gridsheader"> 
	...
	<td nowrap="nowrap" align="center"><?php echo ((is_array($_tmp='cart_product_quantity')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</td>
	<td nowrap="nowrap" align="right"><?php echo ((is_array($_tmp='ordr_itemprice_excluding_tax')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</td>
</tr>
<?php if ($this->_tpl_vars['orderContent']):  unset($this->_sections['i']);
$this->_sections['i']['name'] = 'i';
...
<tr>
	<td colspan="3" style="color: #777777"><?php echo ((is_array($_tmp='lbl_no_products_in_order')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</td>
<?php endif; ?>
...
<?php endif;  if ($this->_tpl_vars['order']['shipping_cost'] || $this->_tpl_vars['order']['tax']): ?>
<tr>
	<td colspan="2"><?php echo ((is_array($_tmp='ordr_subtotal')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</td>
	<td align="right"><?php echo $this->_tpl_vars['order']['clear_total_priceToShow']; ?>
</td>
</tr>
<?php endif;  if ($this->_tpl_vars['order']['shipping_cost']): ?>
<tr>
	<td colspan="2"><?php echo ((is_array($_tmp='ordr_shipping_handling_cost')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</td>
	<td align="right"><?php echo $this->_tpl_vars['order']['shipping_costToShow']; ?>
</td>
</tr>
<?php endif;  if ($this->_tpl_vars['order']['tax']): ?>
<tr>
...
" type="hidden" />
	...
	<?php echo ((is_array($_tmp='ordr_change_status')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
...
'><?php echo $this->_tpl_vars['_status']['status_name']; ?>
	...
	<p>
	<label><input name ="notify_customer" type="checkbox" value="1" onchange="JavaScript:obj=document.getElementById('change_custom_status_comment');if(obj)obj.style.display=this.checked?'block':'none';"><?php echo ((is_array($_tmp='ordr_send_buyer_message')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</label>
...
<br>
	...
	<input value="<?php echo ((is_array($_tmp='btn_change')) ? $this->_run_mod_handler('transcape', true, $_tmp) : smarty_modifier_transcape($_tmp)); ?>
" type="submit" />
...
" type="hidden" />
	...
	<?php echo ((is_array($_tmp='ordr_add_comment')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>

	<p>
	<textarea name="comment" cols="50" rows="4"  maxlength="255"></textarea>
	</p>
	<p><label><input type="checkbox" name="notify_customer" value="1"><?php echo ((is_array($_tmp='ordr_send_buyer_message')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</label></p>
	<input value="<?php echo ((is_array($_tmp='btn_add')) ? $this->_run_mod_handler('transcape', true, $_tmp) : smarty_modifier_transcape($_tmp)); ?>
" type="submit" />
	</form>
</div>
