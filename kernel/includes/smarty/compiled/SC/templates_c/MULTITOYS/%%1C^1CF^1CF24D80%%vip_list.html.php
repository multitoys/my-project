<?php /* Smarty version 2.6.9, created on 2015-09-22 17:52:50
         compiled from /var/www/multitoy/data/www/multitoys.com.ua/published/SC/html/scripts/templates/backend/vip_list.html */ ?>
<?php echo '
<style>
...
<div class="zu_body">
	<h3>Список пользователей с VIP-доступом</h3>
	...
	<?php $_from = $this->_tpl_vars['v_users']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
