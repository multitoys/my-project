<?php /* Smarty version 2.6.9, created on 2015-09-22 10:13:45
         compiled from change_address.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'translate', 'change_address.html', 6, false),array('modifier', 'set_query_html', 'change_address.html', 13, false),)), $this); ?>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "checkout.progress.html", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
  if ($this->_tpl_vars['PAGE_VIEW'] == 'noframe'): ?>
	
	<div class="paddingblock">
	
	<h2><?php echo ((is_array($_tmp='btn_change_address')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</h2>
<?php else: ?>
	<h1><?php echo ((is_array($_tmp='btn_change_address')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</h1>
<?php endif; ?>
...
"><?php echo $this->_tpl_vars['_address']['strAddress']; ?>
	...
	<tr>
		...
		<td>
			<label for="address-id-0"><strong><?php echo ((is_array($_tmp='checkout_another_address')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
:</strong></label>
			<br />
...
unset($_smarty_tpl_vars);
 ?>
	...
	<tr>
		<td></td>
		<td><input type="submit" class="my-button" value='<?php echo ((is_array($_tmp='btn_select')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
' /></td>
	</tr>
	</table>
</form>
<?php echo ((is_array($_tmp='usrreg_required_regform_fields_descr')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
