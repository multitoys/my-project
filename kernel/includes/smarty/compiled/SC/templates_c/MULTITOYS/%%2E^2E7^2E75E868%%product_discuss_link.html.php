...
<h2><?php echo ((is_array($_tmp='pgn_product_reviews')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp));  if ($this->_tpl_vars['rss_link']): ?>&nbsp;<a href="<?php echo @URL_ROOT; ?>
...
'><?php echo ((is_array($_tmp='prddiscussion_add_message')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</a>
	</p>
<?php else: ?>
