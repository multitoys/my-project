...
<script language="JavaScript" type="text/javascript"><!--<?php echo '
	...
	dragsort.onDragEnd = function(dragEvent){
		...
		var item = dragEvent.group.element;
		var action = getLayer("';  echo $this->_tpl_vars['action_id'];  echo '");
		var action_value =false;
		if(action){ 
			action_value = "';  echo $this->_tpl_vars['default_action'];  echo '";
			action.value = "';  echo $this->_tpl_vars['action_name'];  echo '";		
		}	
	...
	function revert_action(action_value){
		getLayer("';  echo $this->_tpl_vars['action_id'];  echo '").value = action_value;
	}
	'; ?>
