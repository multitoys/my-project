<?php /* Smarty version 2.6.9, created on 2015-09-22 12:29:10
         compiled from backend/sales_report.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'translate', 'backend/sales_report.html', 1, false),array('modifier', 'transcape', 'backend/sales_report.html', 5, false),array('modifier', 'set_query_html', 'backend/sales_report.html', 21, false),array('modifier', 'escape', 'backend/sales_report.html', 21, false),array('modifier', 'set_query', 'backend/sales_report.html', 70, false),)), $this); ?>
...
translate.srep_this_p_week = "<?php echo ((is_array($_tmp='srep_this_p_week')) ? $this->_run_mod_handler('transcape', true, $_tmp) : smarty_modifier_transcape($_tmp)); ?>
";
translate.srep_this_p_month = "<?php echo ((is_array($_tmp='srep_this_p_month')) ? $this->_run_mod_handler('transcape', true, $_tmp) : smarty_modifier_transcape($_tmp)); ?>
";
translate.srep_this_p_year = "<?php echo ((is_array($_tmp='srep_this_p_year')) ? $this->_run_mod_handler('transcape', true, $_tmp) : smarty_modifier_transcape($_tmp)); ?>
";
</script>

<p><?php echo ((is_array($_tmp='srep_description')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</p>

<?php if ($this->_tpl_vars['no_orders']): ?>
<div style="text-align: center"><?php echo ((is_array($_tmp='srep_noorders')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</div>
<?php else: ?>
<h2><?php echo ((is_array($_tmp='srep_sreport_thismonth')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</h2>

<div class="blockquote">
<?php echo ((is_array($_tmp='srep_data_range')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
:
...
<h2><?php echo ((is_array($_tmp='srep_compare')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</h2>
<div class="blockquote">
<?php echo ((is_array($_tmp='srep_data_range')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
:
...
<h2><?php echo ((is_array($_tmp='srep_sreport_alltime')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</h2>
