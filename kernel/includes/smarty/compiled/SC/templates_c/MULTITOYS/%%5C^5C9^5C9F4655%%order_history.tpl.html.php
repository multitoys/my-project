...
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'order_history.tpl.html', 15, false),array('modifier', 'set_query', 'order_history.tpl.html', 16, false),array('modifier', 'translate', 'order_history.tpl.html', 26, false),)), $this); ?>
...
<?php else: ?>
	<p><?php echo ((is_array($_tmp='str_no_orders')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</p>
<?php endif; ?>