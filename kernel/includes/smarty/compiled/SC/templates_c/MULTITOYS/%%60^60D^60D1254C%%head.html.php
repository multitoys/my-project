...
<?php if ($this->_tpl_vars['PAGE_VIEW'] == 'mobile'):  echo smarty_function_combine(array('input' => $this->_tpl_vars['css_m_main'],'output' => '/cache/m.main.css','age' => '5'), $this);?>
...
<?php else:  echo smarty_function_combine(array('input' => $this->_tpl_vars['css_main'],'output' => '/cache/main.css','age' => '5'), $this);?>
...
<?php endif;  echo smarty_function_combine(array('input' => $this->_tpl_vars['js_functions'],'output' => '/cache/functions.js','age' => '5','defer' => $this->_tpl_vars['defer']), $this);?>

<?php if ($_SESSION['log']):  if ($this->_tpl_vars['conc']): ?>
<link rel="stylesheet" type="text/css" href="/source/jquery.fancybox.css" media="screen"/>
<script <?php echo ((is_array($_tmp=@$this->_tpl_vars['defer'])) ? $this->_run_mod_handler('default', true, $_tmp, ' ') : smarty_modifier_default($_tmp, ' ')); ?>
 type="text/javascript" src="/lib/jquery.mousewheel-3.0.6.pack.js"></script>
<?php if ($this->_tpl_vars['PAGE_VIEW'] == 'mobile'):  echo smarty_function_combine(array('input' => $this->_tpl_vars['js_m_competitors'],'output' => '/cache/m.competitors.js','age' => '5','defer' => $this->_tpl_vars['defer']), $this);?>

<?php else:  echo smarty_function_combine(array('input' => $this->_tpl_vars['js_competitors'],'output' => '/cache/competitors.js','age' => '5','defer' => $this->_tpl_vars['defer']), $this);?>

<?php endif;  endif;  endif;  echo '
<script>
