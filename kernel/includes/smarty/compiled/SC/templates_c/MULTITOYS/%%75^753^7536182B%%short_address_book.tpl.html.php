...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'translate', 'short_address_book.tpl.html', 3, false),array('modifier', 'replace', 'short_address_book.tpl.html', 13, false),array('modifier', 'set_query', 'short_address_book.tpl.html', 19, false),)), $this); ?>
<tr>
	<td valign="top">
		...
		<?php else: ?>
			<?php echo ((is_array($_tmp='str_not_defined')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
...
"><?php echo ((is_array($_tmp='lnk_manage_address_book')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</a>
	</td>
</tr>