<?php /* Smarty version 2.6.9, created on 2015-09-21 23:33:12
         compiled from news.frontend.post.tpl.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'translate', 'news.frontend.post.tpl.html', 1, false),array('modifier', 'escape', 'news.frontend.post.tpl.html', 10, false),array('modifier', 'set_query', 'news.frontend.post.tpl.html', 17, false),)), $this); ?>
<h1><?php echo ((is_array($_tmp='news')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp));  if ($this->_tpl_vars['rss_link']): ?>&nbsp;<a href="<?php echo @URL_ROOT; ?>
...
"><?php echo ((is_array($_tmp='blog_view_all_posts')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
...</a>
</div>