<?php /* Smarty version 2.6.9, created on 2015-09-22 08:31:09
         compiled from checkout.shipping.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'translate', 'checkout.shipping.html', 1, false),array('modifier', 'set_query_html', 'checkout.shipping.html', 8, false),array('modifier', 'escape', 'checkout.shipping.html', 17, false),array('modifier', 'transcape', 'checkout.shipping.html', 48, false),array('function', 'count', 'checkout.shipping.html', 15, false),)), $this); ?>
	<?php echo ((is_array($_tmp='ordr_shipping_address')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
 (<a href='<?php echo $this->_tpl_vars['change_address_url']; ?>
'><?php echo ((is_array($_tmp='btn_change_address')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</a>):
	<p>
	<strong><?php if ($this->_tpl_vars['shipping_address_str']):  echo $this->_tpl_vars['shipping_address_str'];  else:  echo ((is_array($_tmp='str_not_defined')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp));  endif; ?></strong>
	</p>
	
	<p><?php echo ((is_array($_tmp='checkout_select_shipping_type')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
:</p>
...
" <?php if ($this->_tpl_vars['shippingServiceID'][$this->_tpl_vars['_SID']] == $this->_tpl_vars['_Rate']['id']): ?>selected<?php endif; ?>><?php echo $this->_tpl_vars['_Rate']['name']; ?>
 - <?php echo $this->_tpl_vars['_Rate']['rate']; ?>
			...
			<?php else: ?>
			<?php if ($this->_tpl_vars['shipping_costs'][$this->_sections['i']['index']][0]['name']):  echo $this->_tpl_vars['shipping_costs'][$this->_sections['i']['index']][0]['name'];  if ($this->_tpl_vars['shipping_costs'][$this->_sections['i']['index']][0]['rate']): ?> - <?php endif;  endif;  echo $this->_tpl_vars['shipping_costs'][$this->_sections['i']['index']][0]['rate']; ?>
	...
	<?php else: ?>
		<font color="red"><b><?php echo ((is_array($_tmp='checkout_no_shipping_methods')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
...</b></font>
	<?php endif; ?>
	
	<?php if ($this->_tpl_vars['shipping_methods']): ?><p>
		<input type=submit id=checkout_button name=continue_button class="checkout_buttons blue-button check" value="<?php echo ((is_array($_tmp='checkout_next_step')) ? $this->_run_mod_handler('transcape', true, $_tmp) : smarty_modifier_transcape($_tmp)); ?>
" />
	</p><?php endif; ?>
	
		
	<?php if ($this->_tpl_vars['PAGE_VIEW'] != 'mobile' && $this->_tpl_vars['shipping_methods_count'] > 1): ?> <?php echo '
