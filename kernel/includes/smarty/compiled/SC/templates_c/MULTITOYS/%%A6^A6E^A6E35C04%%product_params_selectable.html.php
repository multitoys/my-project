...
?>
	<tr>					
		<td>
			<?php echo ((is_array($_tmp=$this->_tpl_vars['product_extra'][$this->_sections['i']['index']]['name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html'));  if ($this->_tpl_vars['product_extra'][$this->_sections['i']['index']]['option_show_times'] > 1): ?>(<?php echo smarty_function_counter(array('name' => 'option_show_times'), $this);?>
):<?php else: ?>:<?php endif; ?>
		</td>
		<td>
...
' class="product_option">
			<option value='' rel="0"><?php echo ((is_array($_tmp=((is_array($_tmp='str_not_defined')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
</option>
