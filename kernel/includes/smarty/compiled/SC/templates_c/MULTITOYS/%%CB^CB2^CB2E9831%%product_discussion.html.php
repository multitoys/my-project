...
" class="cat"><?php echo ((is_array($_tmp='lnk_homepage')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</a>
...
unset($_smarty_tpl_vars);
 ?></p>
<?php else: ?>
	<p><?php echo ((is_array($_tmp='prddiscussion_no_posts_on_item_string')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</p>
<?php endif; ?>

<a name="add-review"></a>
<h2><?php echo ((is_array($_tmp='prddiscussion_add_message')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</h2>
...
<tr>
	<td align="right"><?php echo ((is_array($_tmp='str_your_name')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
:</td>
...
<tr>
	<td align=right><?php echo ((is_array($_tmp='str_subject')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
:</td>
...
<tr>
<tr>
	<td align="right" valign="top"><?php echo ((is_array($_tmp='prddiscussion_body')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
:</td>
	<td>
...
<tr>
	<td>&nbsp;</td>
	<td>
		<input type="submit" value="<?php echo ((is_array($_tmp='btn_post_message')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
" />
