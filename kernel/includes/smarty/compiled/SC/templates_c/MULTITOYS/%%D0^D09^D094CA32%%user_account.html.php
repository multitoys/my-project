...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'translate', 'user_account.html', 1, false),)), $this); ?>
<h1><?php echo ((is_array($_tmp='pgn_my_account')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</h1>
...
$this->_sections['op']['last']       = ($this->_sections['op']['iteration'] == $this->_sections['op']['total']);
 if ($this->_tpl_vars['ChildShortHTMLs'][$this->_sections['op']['index']]['tpl'] != ''): ?>
