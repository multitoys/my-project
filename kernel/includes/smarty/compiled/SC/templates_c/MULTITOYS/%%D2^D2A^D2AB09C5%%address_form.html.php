<?php /* Smarty version 2.6.9, created on 2015-09-21 23:56:15
         compiled from address_form.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'address_form.html', 2, false),array('function', 'cycle', 'address_form.html', 6, false),array('modifier', 'translate', 'address_form.html', 7, false),array('modifier', 'escape', 'address_form.html', 9, false),)), $this); ?>
<?php if ($this->_tpl_vars['intable'] !== 0):  echo smarty_function_counter(array('name' => '__af_cnt','assign' => '__af_cnt','print' => false), $this);?>

<table cellspacing="0" class="cellpadding addressform">
<?php endif;  if ($this->_tpl_vars['asknames'] !== 0): ?>
<tr class="row_<?php echo smarty_function_cycle(array('name' => "__afcyycle".($this->_tpl_vars['__af_cnt']),'values' => 'odd,even'), $this);?>
">
	<td><span class="asterisk">*</span><?php echo ((is_array($_tmp='usr_custinfo_first_name')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</td>
	<td>
...
<?php endif;  if (@CONF_ADDRESSFORM_ADDRESS != 2): ?>
<tr class="row_<?php echo smarty_function_cycle(array('name' => "__afcyycle".($this->_tpl_vars['__af_cnt']),'values' => 'odd,even'), $this);?>
">
	<td><?php if (@CONF_ADDRESSFORM_ADDRESS == 0): ?><span class="asterisk">*</span><?php endif;  echo ((is_array($_tmp='str_address')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</td>
	<td>
...
<?php endif;  if (@CONF_ADDRESSFORM_CITY != 2): ?>
<tr class="row_<?php echo smarty_function_cycle(array('name' => "__afcyycle".($this->_tpl_vars['__af_cnt']),'values' => 'odd,even'), $this);?>
">
	<td><?php if (@CONF_ADDRESSFORM_CITY == 0): ?><span class="asterisk">*</span><?php endif;  echo ((is_array($_tmp='usr_custinfo_city')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</td>
	<td>
		<input name="<?php echo $this->_tpl_vars['name_space']; ?>
...
<?php endif;  if (@CONF_ADDRESSFORM_STATE != 2): ?>
<tr class="row_<?php echo smarty_function_cycle(array('name' => "__afcyycle".($this->_tpl_vars['__af_cnt']),'values' => 'odd,even'), $this);?>
">
	<td><?php if (@CONF_ADDRESSFORM_STATE == 0): ?><span class="asterisk">*</span><?php endif;  echo ((is_array($_tmp='usr_custinfo_state')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</td>
	<td>
...
<?php endif;  if (@CONF_ADDRESSFORM_ZIP != 2): ?>
<tr class="row_<?php echo smarty_function_cycle(array('name' => "__afcyycle".($this->_tpl_vars['__af_cnt']),'values' => 'odd,even'), $this);?>
">
	<td><?php if (@CONF_ADDRESSFORM_ZIP == 0): ?><span class="asterisk">*</span><?php endif;  echo ((is_array($_tmp='usr_custinfo_zip')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</td>
	<td>
		<input name="<?php echo $this->_tpl_vars['name_space']; ?>
...
<?php endif;  if ($this->_tpl_vars['countries']): ?>
<tr class="row_<?php echo smarty_function_cycle(array('name' => "__afcyycle".($this->_tpl_vars['__af_cnt']),'values' => 'odd,even'), $this);?>
">
	<td><span class="asterisk">*</span><?php echo ((is_array($_tmp='usr_custinfo_country')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</td>
	<td>
		<select name="<?php echo $this->_tpl_vars['name_space']; ?>
...
<?php endif;  if ($this->_tpl_vars['form_name'] && $this->_tpl_vars['ukey']): ?>
...
function changeStates(country_el)
{
    ...
    req.onreadystatechange = function()
    {
        ...
        var states_el;
        try{
			states_el = document.forms[\'';  echo $this->_tpl_vars['form_name'];  echo '\'].elements[\'';  echo $this->_tpl_vars['name_space'];  echo '[zoneID]\'];
			if(!states_el)throw "err";
		}catch(e){// IE fix
			var form_el = document.forms[\'';  echo $this->_tpl_vars['form_name'];  echo '\'];
    	    for (var i=0;i<form_el.length;i++){
				if(form_el.elements[i].name == \'';  echo $this->_tpl_vars['name_space'];  echo '[zoneID]\'){
        ...
        if(states.length > 0)
        {
            if(!states_el)
            {
	            var pn;
            try{
		            states_el = document.forms[\'';  echo $this->_tpl_vars['form_name'];  echo '\'].elements[\'';  echo $this->_tpl_vars['name_space'];  echo '[state]\'];
    	            ...
    	            for (var i=0;i<form_el.length;i++)
					{
						if(form_el.elements[i].name == \'';  echo $this->_tpl_vars['name_space'];  echo '[state]\'){
					  		states_el = form_el.elements[i];
					  		pn = states_el.parentNode;
			            	pn.removeChild(states_el);
							break;
                ...
                dd.name =\'';  echo $this->_tpl_vars['name_space'];  echo '[zoneID]\';
                dd.className = \'address_elem\';
                
                pn.appendChild(dd);
                states_el = dd;//document.forms[\'';  echo $this->_tpl_vars['form_name'];  echo '\'].elements[\'';  echo $this->_tpl_vars['name_space'];  echo '[zoneID]\'];
            }
            else
            {
        ...
        else
        {
            if(states_el)
            {
                ...
                inp.name = \'';  echo $this->_tpl_vars['name_space'];  echo '[state]\';
    ...
    try
    {
        req.open(null, set_query(\'?ukey=';  echo $this->_tpl_vars['ukey'];  echo '&caller=1&initscript=ajaxservice\'), true);
