<script type="text/javascript">
	var appsArray = new Array ("null",<?php print $appIdsStr;?>);
</script>	
...
<? if ($needAddServiceLink) { ?><td valign='bottom' nowrap style='padding-bottom: 10px'><a href='<?php print $addServiceLink; ?>'><?php print $kernelStrings["app_add_remove_services"];?></a></td><? } ?>
</tr></table>
</div>
<script>
	ae ();
