<?php
	...
	$qr_selectUserScreenAccess = "SELECT APP_ID, SCR_ID FROM USERSCREENACCESS WHERE U_ID='!U_ID!' order by APP_ID, SCR_ID";

	$qr_selectUsrGroupSummaryScreenAccess = "SELECT SGA.SCR_ID, SGA.APP_ID FROM SCR_GROUP_ACCESS SGA, UGROUP_USER UGU WHERE SGA.UG_ID=UGU.UG_ID AND UGU.U_ID='!U_ID!' GROUP BY APP_ID, SCR_ID";

	$qr_selectSpecGroupSummaryScreenAccess = "SELECT SGA.SCR_ID, SGA.APP_ID FROM SCR_GROUP_ACCESS SGA WHERE SGA.UG_ID IN (%s) GROUP BY APP_ID, SCR_ID";

	$qr_selectSpecGroupSummaryAuxRights = "SELECT AUX.AGA_ID, AUX.APP_ID FROM AUX_GROUP_ACCESS AUX WHERE AUX.UG_ID IN (%s) GROUP BY APP_ID, AGA_ID";

	$qr_selectGroupScreenAccess = "SELECT APP_ID, SCR_ID FROM SCR_GROUP_ACCESS WHERE UG_ID='!UG_ID!' order by APP_ID, SCR_ID";

	$qr_selectGroupAuxRights = "SELECT * FROM AUX_GROUP_ACCESS WHERE UG_ID='!UG_ID!' ORDER BY APP_ID, AGA_ID";

	$qr_selectUserAuxRights = "SELECT * FROM AUX_USER_ACCESS WHERE U_ID='!U_ID!' ORDER BY APP_ID, AGA_ID";

	$qr_select_AppAccess = "SELECT U.APP_ID, U.SCR_ID FROM USERSCREENACCESS U WHERE U.U_ID='!U_ID!' order by U.APP_ID, U.SCR_ID";
	...
	$qr_check_user_rights = "SELECT COUNT(*) FROM USERSCREENACCESS WHERE U_ID='!U_ID!' AND SCR_ID='!SCR_ID!' AND APP_ID='!APP_ID!'";

	$qr_check_user_aux_rights = "SELECT COUNT(*) FROM AUX_USER_ACCESS WHERE U_ID='!U_ID!' AND APP_ID='!APP_ID!' AND AGA_ID='!AGA_ID!'";

	$qr_check_group_summary_rights = "SELECT COUNT(*) FROM SCR_GROUP_ACCESS SGA, UGROUP_USER UGU WHERE SGA.UG_ID=UGU.UG_ID AND UGU.U_ID='!U_ID!' AND SGA.APP_ID='!APP_ID!' AND SGA.SCR_ID='!SCR_ID!'";

	$qr_check_group_summary_aux_rights = "SELECT COUNT(*) FROM AUX_GROUP_ACCESS AGA, UGROUP_USER UGU WHERE AGA.UG_ID=UGU.UG_ID AND UGU.U_ID='!U_ID!' AND AGA.APP_ID='!APP_ID!' AND AGA.AGA_ID='!AGA_ID!'";
	...
	$qr_deleteAuxGroupAccess = "DELETE FROM AUX_GROUP_ACCESS WHERE UG_ID='!UG_ID!'";

	$qr_addAuxGroupAccess = "INSERT INTO AUX_GROUP_ACCESS(UG_ID, APP_ID, AGA_ID) VALUES ('!UG_ID!', '!APP_ID!', '!AGA_ID!')";

	$qr_addAuxUserAccess = "INSERT INTO AUX_USER_ACCESS(U_ID, APP_ID, AGA_ID) VALUES ('!U_ID!', '!APP_ID!', '!AGA_ID!')";

	$qr_addGroupScreenAccess = "INSERT INTO SCR_GROUP_ACCESS (UG_ID, APP_ID, SCR_ID) values ('!UG_ID!', '!APP_ID!', '!SCR_ID!')";
	...
	$qr_selectUserAccessList = "SELECT U.U_ID, U.APP_ID, U.SCR_ID FROM USERSCREENACCESS U order by U.APP_ID, U.SCR_ID";

	$qr_select_AppAccessUser = "SELECT U.U_ID, U.APP_ID, U.SCR_ID FROM USERSCREENACCESS U WHERE and S.APP_ID=U.APP_ID order by U.APP_ID, U.SCR_ID";

	$qr_deleteUserScreenAccess = "DELETE FROM U_ACCESSRIGHTS WHERE AR_ID='!U_ID!'";

	$qr_addUserScreenAccess = "INSERT INTO USERSCREENACCESS (U_ID, APP_ID, SCR_ID) values ('!U_ID!', '!APP_ID!', '!SCR_ID!')";

	$qr_deleteAccessGarbage = "DELETE FROM USERSCREENACCESS WHERE APP_ID NOT IN (%s)";
	...
	$qr_host_addContact = "INSERT INTO CONTACT(C_ID, CF_ID, C_CREATEDATETIME, C_CREATEUSERNAME, C_FIRSTNAME, C_LASTNAME, C_EMAILADDRESS) VALUES ('!C_ID!', '!CF_ID!', '!C_CREATEDATETIME!', '!C_CREATEUSERNAME!', '!C_FIRSTNAME!', '!C_LASTNAME!', '!C_EMAILADDRESS!')";
	
	$qr_host_deleteDemoUser = "DELETE FROM WBS_USER WHERE U_ID='DEMO@WEBASYST.NET'";
	
	$qr_host_deleteDemoUserContact = "DELETE FROM CONTACT WHERE C_ID=0";

	$qr_host_grantuseraccess = "INSERT INTO CFACCESS(U_ID, CF_ID, CFA_RIGHTS) VALUES ('!U_ID!', '!CF_ID!', '!CFA_RIGHTS!')";
...
//	$qr_tree_deleteGroupFolderRights = "DELETE FROM TREE_GROUP_ACCESS_TABLE WHERE GROUP_ID_FIELD='!GROUP_ID_FIELD!' AND FOLDER_ID_FIELD='!FOLDER_ID_FIELD!'";
	...
	$qr_tree_selectFolderUsers = "SELECT U.U_ID, UA.*, C.C_LASTNAME, C.C_FIRSTNAME, C.C_MIDDLENAME, C.C_NICKNAME, C.C_EMAILADDRESS FROM U_ACCESSRIGHTS AS UA, CONTACT AS C, WBS_USER U WHERE UA.AR_PATH = '!AR_PATH!' AND UA.AR_OBJECT_ID = '!FOLDER_ID_FIELD!' AND C.C_ID=U.C_ID AND U.U_ID=UA.AR_ID AND U.U_STATUS <> 1 ORDER BY C_FIRSTNAME, C_LASTNAME, C_MIDDLENAME, C_NICKNAME";

//	$qr_tree_selectFolderUsers = "SELECT DA.ACCESS_RIGHT_FIELD, U.U_ID, C.C_LASTNAME, C.C_FIRSTNAME, C.C_MIDDLENAME, C.C_NICKNAME, C.C_EMAILADDRESS FROM TREE_ACCESS_TABLE DA, WBS_USER U, CONTACT C WHERE (U.U_ACCESSTYPE='IND' OR U.U_ACCESSTYPE='SUM') AND C.C_ID=U.C_ID AND DA.FOLDER_ID_FIELD='!FOLDER_ID_FIELD!' AND U.U_ID=DA.USER_ID_FIELD AND U.U_STATUS <> 1 ORDER BY C_FIRSTNAME, C_LASTNAME, C_MIDDLENAME, C_NICKNAME";

	$qr_tree_selectFolderGroupUsers = "SELECT U.U_ID, BIT_OR( UGA.AR_VALUE ) AS GROUPRIGHTS, UGA.AR_ID, C.C_LASTNAME, C.C_FIRSTNAME, C.C_MIDDLENAME, C.C_NICKNAME, C.C_EMAILADDRESS FROM WBS_USER U, UGROUP_USER UGU, UG_ACCESSRIGHTS UGA, CONTACT C WHERE UGU.U_ID = U.U_ID AND UGA.AR_ID = UGU.UG_ID AND       UGA.AR_OBJECT_ID = '!FOLDER_ID_FIELD!' AND UGA.AR_PATH = '!AR_PATH!' AND U.U_STATUS <> 1 AND C.C_ID = U.C_ID GROUP BY UGU.U_ID ORDER BY C_FIRSTNAME, C_LASTNAME, C_MIDDLENAME";

//	$qr_tree_selectFolderGroupUsers = "SELECT U.U_ID, MAX(DGA.GROUP_ACCESS_RIGHT_FIELD) AS ACCESS_RIGHT_FIELD, C.C_LASTNAME, C.C_FIRSTNAME, C.C_MIDDLENAME, C.C_NICKNAME, C.C_EMAILADDRESS FROM WBS_USER U, UGROUP_USER UGU, TREE_GROUP_ACCESS_TABLE DGA, CONTACT C WHERE (U.U_ACCESSTYPE='GROUP' OR U.U_ACCESSTYPE='SUM') AND UGU.U_ID = U.U_ID AND DGA.GROUP_ID_FIELD = UGU.UG_ID AND DGA.FOLDER_ID_FIELD='!FOLDER_ID_FIELD!' AND C.C_ID = U.C_ID GROUP BY UGU.U_ID ORDER BY C_FIRSTNAME, C_LASTNAME, C_MIDDLENAME";
...
//	$qr_tree_selectFolderGroups = "SELECT UG.UG_ID, DGA.GROUP_ACCESS_RIGHT_FIELD AS ACCESS_RIGHT_FIELD, UG.UG_NAME FROM TREE_GROUP_ACCESS_TABLE DGA, UGROUP UG WHERE UG.UG_ID=DGA.GROUP_ID_FIELD AND DGA.FOLDER_ID_FIELD='!FOLDER_ID_FIELD!' ORDER BY UG.UG_NAME";
	...
	$qr_namesortclause = "UPPER(CONCAT(IF(C_FIRSTNAME is not null, C_FIRSTNAME, ''), IF(C_MIDDLENAME is not null, C_MIDDLENAME, ''), IF(C_LASTNAME is not null, C_LASTNAME, ''), IF(C_NICKNAME is not null, C_NICKNAME, ''), IF(C_EMAILADDRESS is not null, C_EMAILADDRESS, '')))";
	...
	$qr_select_clist_contacts = "SELECT CL.C_ID FROM CLIST_CONTACT CL, CONTACT C WHERE CL_ID='!CL_ID!' AND C.C_ID=CL.C_ID ORDER BY UPPER(CONCAT(IF(C_FIRSTNAME is not null, C_FIRSTNAME, ''), IF(C_MIDDLENAME is not null, C_MIDDLENAME, ''), IF(C_LASTNAME is not null, C_LASTNAME, ''), IF(C_NICKNAME is not null, C_NICKNAME, ''), IF(C_EMAILADDRESS is not null, C_EMAILADDRESS, '')))";
