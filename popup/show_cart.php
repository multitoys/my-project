<?php
    ...
    if (isset($_SESSION['cs_id'])) {
        ...
        $query = "
                SELECT 
                      SC_shopping_carts.Quantity, SC_shopping_carts.itemID, 
                      SC_products.Price, SC_products.skidka, SC_products.ukraine
                FROM 
                      SC_shopping_carts
                LEFT JOIN 
                      SC_shopping_cart_items 
                      ON SC_shopping_carts.itemID = SC_shopping_cart_items.itemID
                LEFT JOIN 
                      SC_products 
                      ON SC_shopping_cart_items.productID = SC_products.productID 
                WHERE 
                      SC_shopping_carts.customerID  = $cs_id";
