<?php
	 ...
	 * @param bool $DBKey if $user_mail is DBKEY
	 * 
...
*/			
	...
	**/
	 ...
	 * @return error|null
	 */
	function aa_addCustomerExtraEmails($MTCE_EMAILS, $MTC_ID, $ACTIVATION_URL)
		{
		...
		// mt_addCustomerExtraEmails(  $MTC_ID, $MTCE_EMAILS, $ACTIVATION_URL, $U_ID, $PASSWORD ) 
	 ...
	 * @param string $MTCE_EMAIL Mail for delete
	 * 
	 * @author Ivan Chura
	 * @since PHP 5.2.5 - 28.05.2008
	 * @return error|null
	**/
	function aa_deleteCustomerExtraEmail($MTC_ID, $MTCE_EMAIL){
		...
		$parameters = array(
			"MTC_ID" 				=> base64_encode($MTC_ID),
			"MTCE_EMAIL" 			=> base64_encode($MTCE_EMAIL),
			"U_ID" 				=> base64_encode(AA_MT_SOAP_USER),
			"PASSWORD" 			=> base64_encode(AA_MT_SOAP_PWD)
			 );
