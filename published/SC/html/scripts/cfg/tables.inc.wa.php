...
define('MODULES_SETTINGS_TABLE', DBTABLE_PREFIX.'spmodules_settings');
...
define('TBL_DISCOUNT_COUPONS', DBTABLE_PREFIX.'discount_coupons');
define('TBL_ORDERS_DISCOUNT_COUPONS', DBTABLE_PREFIX.'orders_discount_coupons');
?>