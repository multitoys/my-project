<?php
    ...
    class DataBase
    {
         ...
         */
        function connect($_host, $_user, $_pass, $_type = 'mysqli')
        {
            $this->type = $_type;
            $this->host = $_host;
            $this->user = $_user;
            ...
            switch ($this->type) {
                ...
                case 'mysqli':
                    ...
                    $this->database = SystemSettings::get('DB_NAME');
                    $this->link = mysqli_connect($_host, $_user, $_pass, $this->database);
            ...
            */
            ...
            switch ($this->type) {
                ...
                case 'mysqli':
                    ...
                    $this->result = mysqli_query($this->link, $this->last_sql);
                    if (!$this->result) {
//                        pear_handler();
//                        pear_handler(PEAR::raiseError("Error executing query: " . $this->last_sql . '<br />' . mysqli_error($this->link)));
                        die("Error executing query: " . $this->last_sql . '<br />' . mysqli_error($this->link));
                    }
                    break;
            }
            /*
        ...
        function isTableCreated($_TableName)
        {
            ...
            $Result = $this->query('SELECT 1 FROM `' . xEscapeSQLstring($_TableName) . '` LIMIT 1');
