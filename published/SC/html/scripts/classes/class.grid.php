    ...
    class Grid extends Object
    {
        ...
        function registerHeader($title, $field_name = '', $default_sort = false, $default_sort_direction = 'asc', $align = '', $add_str = '')
        {
            ...
            $this->headers[] = array(
                ...
                'ascsort' => $field_name ? array('getvars' => '&' . $this->get_sort_name . '=' . $field_name . '&' . $this->get_direction_name . '=DESC') : '',
                'descsort' => $field_name ? array('getvars' => '&' . $this->get_sort_name . '=' . $field_name . '&' . $this->get_direction_name . '=ASC') : '',
                'add_str' => $add_str
            );
        ...
        function prepare()
        {
            ...
            $this->rows_num = isset($GetVars['rows_num']) && (int)$GetVars['rows_num'] > 0 ? (int)$GetVars['rows_num'] : $this->rows_num;
            $total_pages = ceil($this->total_rows_num / $this->rows_num);

            $page = isset($GetVars['page']) && (int)($GetVars['page']) > 0 ? (int)$GetVars['page'] : 1;
            ...
            if ($this->show_rows_num_select) $smarty->assign('rows', array(100 => 100, 200 => 200, 500 => 500, 1000 => 1000));
