(function ($) {
    var init = function (userOptions) {
        ...
        this.data("countdown", {start: start, pause: pause});
...
$(document).ready(function () {
    $(function () {
        var akciaNum = $('.zakcia_body').length;
        
        for (var i = 0; i < akciaNum; i++) {
            var seconds = $("#zakcia_body_" + i).attr("data-time");
            var _date = new Date();
            _date.setSeconds(seconds);
            $("#z_counter_" + i).countdown({image: "/img/_digits.png", startTime: _date});
        }
    });
});