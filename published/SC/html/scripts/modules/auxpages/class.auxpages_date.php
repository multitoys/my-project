                        ...
                        $add2cart = ($buy_enabled) ? "
                                            <table width=110px>
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <input class=cart_product_quantity id=qty$Product->productID name=product_qty title='Количество' type=text value='' size=2 data-id=$Product->productID onkeypress='if (event.keyCode == 13){add2Cart(\"#qty$Product->productID\")}' tabindex=$tab>
                                                        </td>
                                                        <td>
