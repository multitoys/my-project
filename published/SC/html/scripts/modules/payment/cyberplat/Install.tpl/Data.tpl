...
'E003',        "Валюта не указана или указана неверно: <
<Param1>>",
    'E004', "Сумма к оплате не указана или указана неверно: <
    <Param1>>",
        'E005', "Некорректный формат e-mail клиента: <
        <Param1>>",
            'E006', "Некорректный формат имени клиента: <
            <Param1>>",
                'E007', "Некорректный формат фамилии клиента: <
                <Param1>>",
                    'E008', "Невозможно подписать запрос магазина/проверить подпись ответа сервера: <
                    <Param1>>",
                        'E009', "Произошла ошибка: <
                        <Param1>>",
                            'E010', "Длина параметра(ов) больше допустимой. Должна быть: <
                            <Param1>>",

                                'F001', "Невозможно открыть файл сессии <
                                <Param1>>: <
                                    <Param2>>",
                                        'F002', "Невозможно получить файл сессии <
                                        <Param1>> в экслюзивный доступ: <
                                            <Param2>>",
                                                'F003', "Невозможно записать данные в файл сессии <
                                                <Param1>>: <
                                                    <Param2>>",
                                                        'F004', "Невозможно отдать файл сессии <
                                                        <Param1>> в общий доступ: <
                                                            <Param2>>",
                                                                'F005', "Невозможно закрыть файл сессии <
                                                                <Param1>>: <
                                                                    <Param2>>",
