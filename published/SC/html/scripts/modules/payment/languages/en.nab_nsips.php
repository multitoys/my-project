<?php
	...
	define('NAB_NSIPS_CFG_CURRENCY_DSCR', 'Order amount transferred to gateway website is denominated in AUD. Specify currency type in your shopping cart which represents AUD (oder amount will be calculated according to AUD exchange rate; if not specified exchange rate will be assumed as 1)');
?>