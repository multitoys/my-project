...
define('YOURPAYCONNECT_CFG_USD_CURRENCY_DSCR',
	'Order amount transferred to YourPay is denominated in USD. Specify currency type in your shopping cart which is assumed as USD (oder amount will be calculated according to USD exchange rate; if not specified exchange rate will be assumed as 1)');
