...
define('IDEALBASIC_EUR_CURRENCY_DSCR', 'Order amount transferred to GSPay is denominated in EUR. Specify currency type in your shopping cart which is assumed as EUR (oder amount will be calculated according to EUR exchange rate; if not specified exchange rate will be assumed as 1)');
