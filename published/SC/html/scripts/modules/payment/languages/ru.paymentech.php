<?php
	...
	define('PAYMENTECH_CFG_PLATFORM_TTL', 'Платформа');
	define('PAYMENTECH_CFG_PLATFORM_DSCR', 'Система, к которой подключен ваш аккаунт. Эту информацию предоставляет вам CHASE Paymentech.');
?>