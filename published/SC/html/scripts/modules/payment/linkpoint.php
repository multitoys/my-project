...
class CLinkPoint extends PaymentModule {
	...
	function _initVars(){
		...
		$this->Settings = 	array( 
			...
			"CONF_PAYMENTMODULE_LINKPOINT_POSTING_URL",
	...
	function _initSettingFields(){
		...
		$this->SettingsFields['CONF_PAYMENTMODULE_LINKPOINT_POSTING_URL'] = array(
			'settings_value' 		=> 'https://www.staging.linkpointcentral.com/lpc/servlet/lppay', 
			'settings_title' 			=> CLINKPOINT_CFG_POSTING_URL_TTL, 
			'settings_description' 	=> CLINKPOINT_CFG_POSTING_URL_DSCR, 
			'settings_html_function' 	=> 'setting_TEXT_BOX(0,', 
			'sort_order' 			=> 1,
		);
	...
	function after_processing_html( $orderID ) 
	{
		...
		$res .= 
			...
			"	<tr>\n".
			"		<td align='center'>\n".
			"<form method='POST' action='".set_query('?ukey=linkpoint')."'>\n".
