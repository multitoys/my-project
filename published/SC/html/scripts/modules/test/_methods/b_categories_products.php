...
//show category name as a title
    ...
    $navigatorHtml = GetNavigatorHtml(_getUrlToNavigate(), 50, 'prdSearchProductByTemplate', $callBackParam, $products, $offset, $count);
    ...
    $smarty->assign("searched_count", str_replace("{N}", $count, translate("msg_n_matches_found")));
