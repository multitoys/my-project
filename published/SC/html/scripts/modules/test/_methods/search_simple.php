...
//	if(isset($PostVars["in_results"]))$in_results = true;
	...
	$searchstring = '';
	$searchtag = '';
	if(isset($GetVars['sort']))$sort = $GetVars['sort'];
	if(isset($PostVars['sort']))$sort = $PostVars['sort'];

	if(isset($GetVars['direction']))$direction = $GetVars['direction'];
	if(isset($PostVars['direction']))$direction = $PostVars['direction'];
