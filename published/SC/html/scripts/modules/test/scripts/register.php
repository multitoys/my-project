    ...
    class RegisterCustomer extends ActionsController
    {
        ...
        public function save()
        {
            ...
            if ((!isset($error) || !$error) && CONF_ENABLE_CONFIRMATION_CODE) {
                ...
                if (!$iVal->checkCode($this->getData('fConfirmationCode'))) {
            ...
            if (!isset($error)) {
                ...
                $registerResult = regRegisterCustomer(
                    $login, $cust_password, $Email, $first_name, $last_name, 
                    $subscribed4news, $additional_field_values, $affiliationLogin
                );
