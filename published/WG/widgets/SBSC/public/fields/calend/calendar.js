...
Calendar.Text["today"] = "�������";
Calendar.Text["wk"] = "���.";
Calendar.Text["wk_tip"] = "����� ������";
Calendar.Text["close"] = "�������";
Calendar.Text["prevyear"] = "���������� ���";
Calendar.Text["nextyear"] = "��������� ���";
Calendar.Text["prevmonth"] = "���������� �����";
Calendar.Text["nextmonth"] = "��������� �����";
...
Calendar.prototype.show = function() {
  ...
  if (this.field && !fromcursor) {
    ...
    if (p.y >= (Canvas.clientHeight - this.element.offsetHeight - 5 + Canvas.scrollTop)) {
      p.y = (Canvas.clientHeight - this.element.offsetHeight - 20) + ((!Calendar.is_ie)?Canvas.scrollTop:0) - this.field.offsetHeight;
    }
