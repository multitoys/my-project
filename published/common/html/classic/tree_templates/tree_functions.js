...
function appRightsContrainer() {
    ...
    this.addCheckbox = function (cbType, cbId) {
        switch (cbType) {
            case 0 :
                this.readCheckboxes.push(cbId);
                break;
            case 1 :
                this.writeCheckboxes.push(cbId);
                break;
            case 2 :
                this.folderCheckboxes.push(cbId);
                break;
        }
    }
    ...
    this.updateCheckboxStates = function (cbType, value) {
        ...
        switch (cbType) {
            case 0 :
                cbArray = this.readCheckboxes;
                break;
            case 1 :
                cbArray = this.writeCheckboxes;
                break;
            case 2 :
                cbArray = this.folderCheckboxes;
                break;
        }
