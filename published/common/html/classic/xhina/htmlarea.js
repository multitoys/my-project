/*--------------------------------------:noTabs=true:tabSize=2:indentSize=2:--
 ...
 --  $LastChangedDate: 2006-10-30 03:16:21 +0300 (Пн, 30 окт 2006) $
...
HTMLArea.version =
{
    ...
    'Date': '$LastChangedDate: 2006-10-30 03:16:21 +0300 (Пн, 30 окт 2006) $'.replace(/^[^:]*: ([0-9-]*) ([0-9:]*) ([+0-9]*) \((.*)\) \$/, '$4 $2 $3'),
    'Revision': '$LastChangedRevision: 605 $'.replace(/^[^:]*: (.*) \$$/, '$1'),
...
HTMLArea.loadPlugin = function (pluginName, callback) {
    ...
    HTMLArea._loadback(plugin_file, callback ? function () {
        callback(pluginName);
    } : null);
    return false;
};
...
HTMLArea.loadPlugins = function (plugins, callbackIfNotReady) {
    ...
    if (callbackIfNotReady) {
        setTimeout(function () {
            if (HTMLArea.loadPlugins(plugins, callbackIfNotReady)) {
                callbackIfNotReady();
            }
        }, 150);
    }
...
HTMLArea.prototype.updateToolbar = function (noStatus) {
    ...
    if (0 && HTMLArea.is_gecko) {
        ...
        if (s && s.isCollapsed && s.anchorNode &&
            ...
            s.anchorNode.nodeType == 3 && s.anchorOffset == s.anchorNode.length && !( s.anchorNode.parentNode.nextSibling && s.anchorNode.parentNode.nextSibling.nodeType == 3 ) && !HTMLArea.isBlockElement(s.anchorNode.parentNode)) {
