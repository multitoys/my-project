...
<head>
    ...
    <?php if (!empty($IMConfig['use_color_pickers'])) { ?>
        <script type="text/javascript" src="../../popups/color_picker.js"></script><?php } ?>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td nowrap style="padding:10px;">
                    ...
                    <select name="viewtype" id="viewtype" onChange="updateView()">
                        <option value="thumbview" <?php if ($IMConfig['view_type'] == "thumbview") echo "selected"; ?> >
                            Thumbnail View
                        </option>
                        <option value="listview" <?php if ($IMConfig['view_type'] == "listview") echo "selected"; ?> >
                            List View
                        </option>
                    </select>
                </td>
            ...
            <tr>
                <td style="padding:10px; padding-top:0px;">
                    <div id="messages" style="display: none;"><span id="message"></span><img
                                src="<?php print $IMConfig['base_url']; ?>img/dots.gif" width="22" height="12"
                                alt="..."/></div>
                    <iframe src="<?php print $IMConfig['backend_url']; ?>__function=images&amp;mode=<?php echo $insertMode; ?>&amp;viewtype=<?php echo $IMConfig['view_type'] ?>"
                            name="imgManager" id="imgManager" class="imageFrame" scrolling="auto"
    ...
    <table class="inputTable">
        <tr>
            <td align="right" nowrap><label
                        for="f_url"><?php if ($insertMode == 'image') echo 'File Name'; else echo 'URL'; ?></label></td>
            <td colspan="5"><input type="text"
                                   id="<?php if ($insertMode == 'image') echo 'f_url'; else echo 'f_href'; ?>"
                                   class="largelWidth" value=""/></td>
            <td rowspan="<?php echo $num_rows ?>" colspan="2" valign="top"
                align="center"><?php if ($insertMode == 'image') { ?>
                ...
                <?php } else if ($insertMode == "link" && $IMConfig['link_enable_target'] !== false) { ?><label
                        for="f_align">Target Window</label>
        ...
        <tr>
            ...
            <td align="right"><?php if ($insertMode == 'image' && $IMConfig['images_enable_styling'] !== false) { ?>
                    <label for="f_margin">Margin</label><?php } ?></td>

            <td><?php if ($insertMode == 'image' && $IMConfig['images_enable_styling'] !== false) { ?><input type="text"
                                                                                                             id="f_margin"
                                                                                                             class="smallWidth"
                                                                                                             value=""/><?php } ?>
            </td>
        ...
        <tr>
            ...
            <?php if ($insertMode == 'image' && !empty($IMConfig['use_color_pickers']) && $IMConfig['images_enable_styling'] !== false) { ?>
                ...
                <td>
                    <input name="f_backgroundColor" type="text" id="f_backgroundColor" size="7"/><input type="button"
                                                                                                        id="bgCol_pick"
                                                                                                        value="..."/>
                </td>
            <?php } ?>
        ...
        <tr>
            <td align="right"><?php if ($insertMode == 'image' && $IMConfig['images_enable_align'] !== false) { ?><label
                        for="f_align">Align</label><?php } ?></td>
            ...
            <?php if ($insertMode == 'image' && !empty($IMConfig['use_color_pickers']) && $IMConfig['images_enable_styling'] !== false) { ?>
                ...
                <td><input name="f_borderColor" type="text" id="f_borderColor" size="7"/><input type="button"
                                                                                                id="bdCol_pick"
                                                                                                value="..."/></td>
            <?php } ?>
        </tr>
