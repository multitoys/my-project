...
<table border="0" width="100%" style="padding: 0px; margin: 0px">
    ...
    <tr>
        <td>Images on the Server:<br>
            ...
            <button type="submit" name="ok" onclick="return onUpload();">Upload file</button>
            <br>
        ...
        <td valign="center" width="200" height="230">
            ...
            <a href="#" onClick="javascript:openFile();" title=" Open file in new window"><img src="img/btn_open.gif"
                                                                                               width="18" height="18"
                                                                                               border="0"
                                                                                               title="Open file in new window"/></a><br/>
            <iframe name="ipreview" id="ipreview" frameborder="0" style="border : 1px solid gray;" height="200"
                    width="200" src=""></iframe>
        </td>
    </tr>
    </tbody>
</table>
        ...
        <tr>
            ...
            <td><input type="text" name="url" id="f_url" style="width:75%"
                ...
                <button name="preview" onclick="return onPreview();"
                        title="Preview the image in a new window">Preview
                </button>
            </td>
        </tr>
        <tr>
