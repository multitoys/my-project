...
function colorPicker(params) {
    ...
    var pickrow = 0;
    var pickcol = 0;
    this.callback = params.callback ? params.callback : function (color) {
    ...
    function hsvToRGB(h, s, v) {
        ...
        if (s === 0) {
            ...
            switch (i) {
                case 0:
                    colors = {red: v, green: t, blue: p};
                    break;
                case 1:
                    colors = {red: q, green: v, blue: p};
                    break;
                case 2:
                    colors = {red: p, green: v, blue: t};
                    break;
                case 3:
                    colors = {red: p, green: q, blue: v};
                    break;
                case 4:
                    colors = {red: t, green: p, blue: v};
                    break;
                default:
                    colors = {red: v, green: p, blue: q};
                    break;
            }
        }
...
//            	 unpickCell(pickrow,pickcol);
                    ...
                    td.ondblclick = function () {
                        colorPicker.remember(this.colorCode, picker.savecolors);
                        picker.callback(this.colorCode);
                        picker.close();
                    };
...
//            unpickCell(valuerow,valuecol);
            ...
            but.style.cursor = 'pointer';
            but.onclick = function () {
                colorPicker.remember(picker.chosenColor.value, picker.savecolors);
                picker.callback(picker.chosenColor.value);
                picker.close();
            };
