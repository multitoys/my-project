Ext.onReady(function () {
    ...
    foldersTree = new Tree.TreePanel({
        el: 'tree-div', autoHeight: true, border: false,
    ...
    foldersTree.getWidgetsNode = function () {
        if (foldersTree.widgetsNode == null) {
            var widgetsNode = new Ext.tree.AsyncTreeNode({
                text: config.strings.widgetsLabel,
                iconCls: "widgets-folder",
                allowDrag: false,
                allowDrop: false,
                id: "WIDGETS"
            });
    ...
    foldersTree.getSearchNode = function (searchString) {
        if (foldersTree.searchNode == null) {
            var searchNode = new Ext.tree.TreeNode({
                text: config.strings.searchResultsLabel + ': ' + searchString,
                iconCls: "search-folder",
                allowDrag: false,
                allowDrop: false,
                id: "SEARCH"
            });
