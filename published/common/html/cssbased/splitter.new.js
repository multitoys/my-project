...
Splitter = function () {
    return {
        init: function () {
            ...
            innerLayout = new Ext.BorderLayout('SplitterRightPanelWrapper', {
                north: {initialSize: northInitSize},
                center: {autoScroll: true},
                south: {initialSize: footerInitSize, background: false}
            });
        ...
        reloadRight: function () {
            ...
            innerLayout = new Ext.BorderLayout('SplitterRightPanelWrapper', {
                north: {initialSize: northInitSize},
                center: {autoScroll: true},
                south: {initialSize: footerInitSize}
            });
