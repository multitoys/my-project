...
Ext.KeyMap.prototype = {
    stopEvent: false, addBinding: function (D) {
        if (D instanceof Array) {
...
Ext.data.JsonStore = function (A) {
    Ext.data.JsonStore.superclass.constructor.call(this, Ext.apply(A, {
        proxy: !A.data ? new Ext.data.HttpProxy({url: A.url}) : undefined,
...
Ext.layout.FitLayout = Ext.extend(Ext.layout.ContainerLayout, {
    monitorResize: true, onLayout: function (A, B) {
...
Ext.WindowGroup = function () {
    ...
    return {
        zseed: 9000, register: function (H) {
            F[H.id] = H;
            D.push(H);
            H.on("hide", A)
        }, unregister: function (H) {
...
Ext.TabPanel = Ext.extend(Ext.Panel, {
    ...
    onRender: function (C, A) {
        ...
        this.stripWrap = B.createChild({
            ...
            cn: {tag: "ul", cls: "x-tab-strip x-tab-strip-" + this.tabPosition}
        });
...
Ext.SplitButton = Ext.extend(Ext.Button, {
    arrowSelector: "button:last", initComponent: function () {
...
(function () {
    ...
    Ext.extend(A, Ext.BoxComponent, {
        ...
        autoCreate: {cls: "x-toolbar x-small-editor", html: "<table cellspacing=\"0\"><tr></tr></table>"},
...
Ext.extend(Ext.Tip.DD, Ext.dd.DD, {
    moveOnly: true, scroll: false, headerOffsets: [100, 25], startDrag: function () {
        ...
        if (!this.node.preventHScroll) {
            ...
            if (!Ext.isIE) {
                try {
                    ...
                    this.anchor.focus();
                    B.scrollLeft = A;
                    B.parentNode.parentNode.parentNode.parentNode.scrollLeft = A
                } catch (C) {
                }
            }
        }
...
Ext.extend(Ext.menu.Separator, Ext.menu.BaseItem, {
    itemCls: "x-menu-sep", hideOnClick: false, onRender: function (A) {
        var B = document.createElement("span");
...
Ext.extend(Ext.menu.Adapter, Ext.menu.BaseItem, {
    canActivate: true, onRender: function (B, A) {
...
Ext.extend(Ext.menu.DateMenu, Ext.menu.Menu, {
    cls: "x-date-menu", beforeDestroy: function () {
        this.picker.destroy()
    }
});
...
Ext.form.NumberField = Ext.extend(Ext.form.TextField, {
    ...
    initEvents: function () {
        ...
        var A = function (D) {
            ...
            var E = D.getCharCode();
            if (false && B.indexOf(String.fromCharCode(E)) === -1) {
                D.stopEvent()
            }
        };
...
Ext.form.Radio = Ext.extend(Ext.form.Checkbox, {
    ...
    getGroupValue: function () {
        ...
        return A.child("input[name=" + this.el.dom.name + "]:checked", true).value
    },
    onClick: function () {
        if (this.el.dom.checked != this.checked) {
...
Ext.form.FieldSet = Ext.extend(Ext.Panel, {
    baseCls: "x-fieldset", layout: "form", onRender: function (B, A) {
        if (!this.el) {
...
Ext.form.HtmlEditor = Ext.extend(Ext.form.Field, {
    ...
    iframePad: 3,
    hideMode: "offsets",
    defaultAutoCreate: {tag: "textarea", style: "width:500px;height:300px;", autocomplete: "off"},
    initComponent: function () {
...
Ext.extend(Ext.grid.HeaderDragZone, Ext.dd.DragZone, {
    maxDragWidth: 120, getDragData: function (C) {
...
Ext.extend(Ext.grid.SplitDragZone, Ext.dd.DDProxy, {
    fly: Ext.Element.fly, b4StartDrag: function (A, D) {
        this.view.headersDisabled = true;
...
Ext.extend(Ext.grid.GridDragZone, Ext.dd.DragZone, {
    ddGroup: "GridDD", getDragData: function (B) {
...
Ext.ProgressBar = Ext.extend(Ext.BoxComponent, {
    baseCls: "x-progress", waitTimer: null, initComponent: function () {
