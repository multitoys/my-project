    ...
    <tr>
        <td align="center" valign="middle">
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="7" background="../../../login/res/frames/formtop.gif"><img
                                src="../../../login/res/frames/formlefttop.gif" width="7" height="7"></td>
                    <td background="../../../login/res/frames/formtop.gif"><img
                                src="../../../login/res/frames/formtop.gif" width="1" height="7"></td>
                    <td width="17"><img src="../../../login/res/frames/formtopright.gif" width="17" height="7"></td>
                </tr>
                <tr>
                    <td width="7" background="../../../login/res/frames/formleft.gif"><img
                                src="../../../login/res/frames/formleft.gif" width="7" height="1"></td>
                    ...
                    <td width="17" background="../../../login/res/frames/formright.gif"><img
                                src="../../../login/res/frames/formright.gif" width="17" height="1"></td>
                </tr>
                <tr>
                    <td width="7" background="../../../login/res/frames/formbottom.gif"><img
                                src="../../../login/res/frames/formleftbottom.gif" width="7" height="16"></td>
                    <td background="../../../login/res/frames/formbottom.gif"><img
                                src="../../../login/res/frames/formbottom.gif" width="1" height="16"></td>
