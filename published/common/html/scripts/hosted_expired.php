...
<CENTER>
    ...
    <DIV style="PADDING-BOTTOM: 30px; PADDING-TOP: 40px"><A href="<?= $data_url ?>/"><IMG
                    src="<?= $data_url ?>/images/wa-logo-homepage-<?= $language ?>.gif" border=0></A></DIV>
    <DIV
    ...
    <P class=small><I><?= $locStrings['app_copyright'] ?></I></P></CENTER>
<br/>
