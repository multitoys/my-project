...
:
    "Вы в режиме отображения Html-кода. нажмите кнопку [<>], чтобы переключиться в визуальный режим.",
...
:
    "Кнопка Вставить не работает в браузерах на основе Mozilla (по техническим причинам, связанным с безопасностью). Нажмите Ctrl-V на клавиатуре, чтобы вставить.",

        "Your Document is not well formed. Check JavaScript console for details."
:
    "Ваш документ неправильно сформирован. Посмотрите Консоль JavaScript, чтобы узнать подробности.",
...
:
    "Оставьте пустым, чтобы убрать рамку",

        //Insert Link
        "Insert/Modify Link"
:
    "Вставка/изменение ссылки",
        "None (use implicit)"
:
    "По умолчанию",
        "New window (_blank)"
...
:
    "Вы должны указать URL, на который будет указывать ссылка",
        "You need to select some text before creating a link"
:
    "Вы должны выделить текст, который будет преобразован в ссылку",
...
:
    "Расстояние между границей ячейки и текстом",
        "You must enter a number of rows"
:
    "Вы должны ввести количество строк",
        "You must enter a number of columns"
:
    "Вы должны ввести количество столбцов",
...
:
    "Для браузеров, которые не отображают картинки",
...
:
    "Необходимо ввести URL",
        "You must uload the file or enter the URL"
:
    "Необходимо загрузить файл или ввести URL",
...
:
    "Редактор поддерживает следующие комбинации клавиш:",
        "ENTER"
:
    "ENTER",
        "new paragraph"
...
:
    "Очистить текст, вставленный из Word",
        "Headings"
:
    "Заголовки",
        "Close"
...
:
    "Регистрация правой панели",
        "Register panel left"
:
    "Регистрация левой панели",
        "Register panel top"
:
    "Регистрация верхней панели",
        "Register panel bottom"
:
    "Регистрация нижней панели",
        "Create Toolbar"
:
...
:
    "Создание объекта Xinha",
        "Init editor size"
:
    "Инициализация размера редактора",
        "Init IFrame"
:
...
:
    "Загрузить изображение",
        "The file doesn't have correct extension."
:
    "Файл имеет недопустимое расширение",
        "The file is to big."
:
    "Размер файла превышает максимально допустимое значение",
        "Insert variable"
:
    "Вставить переменную"
}
