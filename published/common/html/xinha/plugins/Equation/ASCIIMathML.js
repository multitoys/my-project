...
var AMsqrt = {input: "sqrt", tag: "msqrt", output: "sqrt", tex: null, ttype: UNARY}, AMroot = {
    input: "root",
    tag: "mroot",
    output: "root",
    tex: null,
    ttype: BINARY
}, AMfrac = {input: "frac", tag: "mfrac", output: "/", tex: null, ttype: BINARY}, AMdiv = {
    input: "/",
    tag: "mfrac",
    output: "/",
    tex: null,
    ttype: INFIX
}, AMover = {input: "stackrel", tag: "mover", output: "stackrel", tex: null, ttype: BINARY}, AMsub = {
    input: "_",
    tag: "msub",
    output: "_",
    tex: null,
    ttype: INFIX
}, AMsup = {input: "^", tag: "msup", output: "^", tex: null, ttype: INFIX}, AMtext = {
    input: "text",
    tag: "mtext",
    output: "text",
    tex: null,
    ttype: TEXT
}, AMmbox = {input: "mbox", tag: "mtext", output: "mbox", tex: null, ttype: TEXT}, AMquote = {
    input: "\"",
    tag: "mtext",
    output: "mbox",
    tex: null,
...
var AMsymbols = [{input: "alpha", tag: "mi", output: "\u03b1", tex: null, ttype: CONST}, {
    input: "beta",
    tag: "mi",
    output: "\u03b2",
    tex: null,
    ...
    tex: "times",
    ttype: CONST
}, {input: "-:", tag: "mo", output: "\xf7", tex: "divide", ttype: CONST}, {
    input: "@",
    tag: "mo",
    output: "\u2218",
    tex: "circ",
    ...
    tex: "nabla",
    ttype: CONST
}, {input: "+-", tag: "mo", output: "\xb1", tex: "pm", ttype: CONST}, {
    input: "O/",
    tag: "mo",
    output: "\u2205",
    tex: "emptyset",
    ...
    tex: null,
    ttype: CONST
}, {input: "quad", tag: "mo", output: "\xa0\xa0", tex: null, ttype: CONST}, {
    input: "qquad",
    tag: "mo",
    ...
    ttype: UNARY,
    acc: true
}, {input: "bar", tag: "mover", output: "\xaf", tex: "overline", ttype: UNARY, acc: true}, {
    input: "vec",
    tag: "mover",
    output: "\u2192",
    tex: null,
