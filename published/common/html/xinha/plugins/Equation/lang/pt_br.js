...
:
    "Inserir Fórmula AsciiMath",
        "AsciiMathML Example"
:
    "Exemplo AsciiMathML",
        "Based on ASCIIMathML by"
:
    "Baseado no ASCIIMathML por",
        "Cancel"
:
    "Cancelar",
        "Equation"
...
:
    "Para maiores informações do AsciiMathML visite este site:",
        "Formula Editor"
:
    "Editor de Fórmula",
        "Input"
...
:
    "`&quot;texto&quot;`",
        ...
        "Attention Internet Explorer users: Please note that there is no WYSIWYG representation of the formula in the editor! You might wish to use Mozilla Firefox instead."
:
    "Atenção usuários do Internet Explorer: Observe que não é possível representar fórmulas no editor no modo de visualização! É preferivelmente que você utilize o Mozilla Firefox.",
        "Show MathML"
:
    "Mostrar MathML",
...
:
    "Atenção: Não é possível editar a fórmula no editor. Ppor favor, utilize este caixa de diálogo!"
}
