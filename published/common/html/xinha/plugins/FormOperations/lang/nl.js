...
:
    "Tekst, wachtwoord of verborgen veld invoegen",
        "Insert a multi-line text field."
:
    "Een tekstveld met meerdere lijnen invoegen",
        "Insert a select field."
:
    "Een selectielijst invoegen",
        "Insert a check box."
:
    "Een checkbox invoegen",
        "Insert a radio button."
:
    "Een radio knop invoegen",
        "Insert a submit/reset button."
:
    "Een verzend/wis knop invoegen"
}
;