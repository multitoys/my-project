...
:
    "Entre com o nome para nova opção",
        "Form Editor"
:
...
:
    "Inserir um Formulário.",
        "Insert a check box."
:
    "Inserir uma caixa de opção",
        "Insert a multi-line text field."
:
    "Inserir um texto multi-linha.",
        "Insert a radio button."
:
    "Inserir um campo de escolha",
        "Insert a select field."
:
    "Inserir seleção.",
        "Insert a submit/reset button."
:
    "Inserir um botão de envio/reset",
        "Insert a text, password or hidden field."
:
    "Inserir um texto, senha ou campo escondido."
}
