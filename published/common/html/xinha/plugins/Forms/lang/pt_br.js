...
:
    "Elemento do formulário: FIELDSET",
        "Form Element: INPUT"
:
    "Elemento do formulário: INPUT",
        "Form Element: LABEL"
:
    "Elemento do formulário: LABEL",
        "Form Element: SELECT"
:
    "Elemento do formulário: SELECT",
        "Form Element: TEXTAREA"
:
    "Elemento do formulário: TEXTAREA",
        "Form Name:"
:
    "Nome do Formulário:",
        "Form handler script"
...
:
    "Formulário para CGI (padrão)",
        "Hard"
:
    "Difícil",
        "Height in number of rows"
:
    "Altura em número de linhas",
        "Image URL:"
:
    "URL da imagem:",
        "Image source"
...
:
    "Texto Inicial:",
        "Insert/Edit Form"
:
    "Inserir/Editar Formulário",
        "Insert/Edit Form Element FIELDSET"
:
    "Inserir/Editar Elemento FIELDSET",
        "Insert/Edit Form Element INPUT"
:
    "Inserir/Editar Elemento INPUT",
        "Insert/Edit Form Element LABEL"
:
    "Inserir/Editar Elemento LABEL",
        "Insert/Edit Form Element SELECT"
:
    "Inserir/Editar Elemento SELECT",
        "Insert/Edit Form Element TEXTAREA"
:
    "Inserir/Editar Elemento TEXTAREA",
        "Javascript for button click"
:
    "Javascript para botão de clicar",
        "Label:"
:
    "Etiqueta:",
        "Legend:"
...
:
    "Máximo número de caracteres aceitos",
        "Method:"
:
    "Método:",
        "Name"
...
:
    "Nome do formulário de entrada",
        "Name of the form select"
:
    "Nome do formulário de seleção",
        "Name/ID:"
:
    "Nome/ID:",
        "OK"
...
:
    "Valor do formulário de entrada",
        "Value:"
:
    "Valor:",
        "Virtual"
...
:
    "Você precisa entrar com um Nome",
        "multipart Form Data (File-Upload)"
:
    "Formulário de dados multipart (Enviar arquivo)",
        "name of the textarea"
:
    "nome da área de texto",
        "normal"
:
    "normal",
        "nowrap"
