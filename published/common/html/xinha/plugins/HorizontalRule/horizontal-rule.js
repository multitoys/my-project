...
HorizontalRule.prototype._editHorizontalRule = function (_8) {
    ...
    if (_8) {
        ...
        _b = {
            f_size: parseInt(_8.style.height, 10) || _8.size,
            f_widthUnit: (/(%|px)$/.test(_c)) ? RegExp.$1 : "px",
            f_width: parseInt(_c, 10),
            f_color: Xinha._colorToRgb(_8.style.backgroundColor) || _8.color,
            f_align: _8.style.textAlign || _8.align,
            f_noshade: (parseInt(_8.style.borderWidth, 10) == 0) || _8.noShade
        };
    }
