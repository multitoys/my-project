...
Xinha.prototype._insertImage = function (_2) {
    ...
    if (_2) {
        _4 = {
            f_url: Xinha.is_ie ? _2.src : _2.src,
            f_alt: _2.alt,
            f_border: _2.style.borderWidth ? _2.style.borderWidth : _2.border,
            f_align: _2.align,
            f_padding: _2.style.padding,
            f_margin: _2.style.margin,
            f_width: _2.width,
            f_height: _2.height,
            f_backgroundColor: _2.style.backgroundColor,
            f_borderColor: _2.style.borderColor
        };
