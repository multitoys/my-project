...
<table border="0" width="100%" style="padding: 0px; margin: 0px">
    <tr>
        <td style="vertical-align: top">
            ...
            <div id="filesList"
                 style="width: 20em; height: 10em; border: 1px solid gray; background: white; padding: 2px 5px">
                <?php
...
<form action="" method="get">
    ...
    <fieldset style="float:left; margin-left: 5px">
        ...
        <table>
            ...
            <tr>
                <td>Vertical:</td>
                <td><input type="text" name="vert" id="f_vert" size="5" title="Vertical padding">
                <td>
            </tr>
        </table>
    </fieldset>
