...
:
    " Abrir arquivo em um nova janela",
        "Absbottom"
:
    "Inferior Absoluto",
        "Absmiddle"
...
:
    "Deixe em branco para sem bordas",
        "Leave empty for not defined"
:
    "Deixe em branco para não definido",
        "Left"
:
    "Esquerda",
        "Middle"
...
:
    "Visualizar imagem em uma nova janela",
        "Right"
:
    "Direita",
        "Size"
...
:
    "O arquivo que você está enviando não possuia a extensão correta.",
        "The file you are uploading already exists."
:
    "Já existe o arquivo que você está enviando.",
        "The file you are uploading is to big. The max Filesize is"
:
    "O arquivo que você está enviando é muito grande. O tamanho máximo é",
