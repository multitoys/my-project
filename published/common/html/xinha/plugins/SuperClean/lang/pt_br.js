...
:
    "Limpar códigos mal formatados do Microsoft Word",
        "Clean up HTML"
:
    "Limpar HTML",
        "General tidy up and correction of some problems."
:
    "Limpesa geral e correção de alguns problemas.",
        "OK"
:
    "",
        "Please select from the following cleaning options..."
:
    "Por favor, selecione uma das opções de limpesa...",
        "Remove custom font sizes."
:
    "Remover tamanho de fontes personalizados (font size).",
        "Remove custom text colors."
:
    "Remover cores de texto personalizados (font color).",
        "Remove custom typefaces (font \"styles\")."
:
    "Remover tipos de letras personalizadas (font \"styles\").",
        "Remove lang attributes."
:
    "Remover atributos de idioma.",
...
:
    "Limpesa falhou. Verifique seu HTML por erros de sintaxe.",
        "You don't have anything to tidy!"
:
    "Você não possui nada para limpar!"
}
