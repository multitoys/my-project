...
:
    "Xinha отказалась удалять последнюю ячейку в строке.",
        "Xinha cowardly refuses to delete the last column in table."
:
    "Xinha отказалась удалять последний столбец в таблице.",
        "Xinha cowardly refuses to delete the last row in table."
:
    "Xinha отказалась удалять последнюю строку в таблице.",
        "percent"
:
    "процентов",
        "pixels"
