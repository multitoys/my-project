...
(function ($) { // hide the namespace
    ...
    $.extend(Datepicker.prototype, {
        ...
        _newInst: function (target, inline) {
            return {
                id: target[0].id, input: target, // associated target
        ...
        _doKeyDown: function (e) {
            ...
            if ($.datepicker._datepickerShowing)
                switch (e.keyCode) {
                    ...
                    case 33:
                        $.datepicker._adjustDate(e.target, (e.ctrlKey ? -1 :
        ...
        _showDatepicker: function (input) {
            ...
            if (!$.datepicker._pos) { // position below input
                $.datepicker._pos = $.datepicker._findPos($('img', input.parentNode)[0]);
        ...
        _checkExternalClick: function (event) {
            ...
            if (($target.parents('#' + $.datepicker._mainDivId).length == 0) && !$target.hasClass($.datepicker.markerClassName) && !$target.hasClass($.datepicker._triggerClass) &&
