...
<br>
<br>
<input name="access" type="checkbox" value="ssl" <?php if ($isSSL) echo "checked"; ?>><?= $locStrings['app_use_ssl']?>
<br>
<a href="forgot.php" title="<?= $locStrings['app_forgotpassword_link'];?>"><?php echo $locStrings['app_forgotpassword_link'];?></a>
<br>
