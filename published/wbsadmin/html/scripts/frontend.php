<?php
    ...
    do {
        ...
        foreach (array('SC' => array('', 'shop/'), 'none' => array(translate('fes_frontend_blank'), null), 'login' => array(translate('fes_frontend_login'), 'login/')) as $key => $val) {
            if (strlen($key) == 2) {
