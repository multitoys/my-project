<?php
    ...
    class Preproc extends Smarty
    {
        ...
        {
            return WebQuery::getPublishedUrl("$app/".$filename);
        }

        public function getTemplatesUrl($filename)
        {
            return WebQuery::getPublishedUrl("common/templates/".$filename);
        }

        public function getPublishedUrl($filename = "")
        {
            return WebQuery::getPublishedUrl($filename);
        }

        public function assignStringsToJs($section)
        {
            $strings = Locale::getSectionStrings($section);
