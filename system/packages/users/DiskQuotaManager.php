<?php
    ...
    class DiskQuotaManager extends DbModel
    {
        ...
        {
            $sql = "SELECT U.U_ID, C.C_FIRSTNAME, C.C_MIDDLENAME, C.C_LASTNAME, C_NICKNAME, C.C_EMAILADDRESS, DU.DU_SIZE USED, UDQ.UDQ_SIZE QUOTA
            ...
            $spaces = $this->prepare($sql)->query(array('app_id' => $app_id))->fetchAll();
            foreach ($spaces as &$user_stat) {
                $user_stat['NAME'] = Users::getUserDisplayName($user_stat);
