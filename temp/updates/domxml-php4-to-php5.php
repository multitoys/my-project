<?php
    ...
    class php4DOMNode
    {
        ...
        {
            return ($this->myDOMNode->nodeType == XML_TEXT_NODE) && preg_match('/^[\s\x00-\x1F\x7F]*$/', $this->myDOMNode->nodeValue);
        }
    ...
    if (extension_loaded('xsl')) {//Voir aussi : http://alexandre.alapetite.net/doc-alex/xslt-php4-php5/
