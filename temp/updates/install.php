...
//
    ...
    function fileContent($filePath)
    {
        ...
        if (function_exists('get_magic_quotes_gpc') && version_compare('5.3', PHP_VERSION, '>') && @get_magic_quotes_gpc()) {
...
';
    ...
    */
    ...
    function step2()
    {
        ...
        <div id="main_comment">
            <p><?php
                    ...
                    elseif ($actionType == ACTION_UPDATE) { ?> <input type=hidden
                                                                      name=oldSysVersion
                                                                      value="<?php echo $sysVersion; ?>"><?php echo $locString['note_inst'];
            ...
            <?php if ($DBlistIsTruncated) { ?>
                <p><a href="<?php echo $fullDbList ?>"
                      target="_blank"><?php echo $locString['upd_db_full_list_link']; ?>.</a></p>
            <?php } ?>
            <p><a href="showmucontent.php" target="_blank"><?php echo sprintf($locString['upd_meta_info'], ''); ?></a>
            </p>
            <hr size="1">
        ...
        <?php if ($actionType != ACTION_NOACTION) {
        stepform(3);
    } ?>
...
<table border="0" cellpadding="3" cellspacing="0" width="75%">
    ...
    <?php if (!$gd) { ?>
        <tr>
            <td>&nbsp;</td>
            <td>
                <FONT color=red><?php echo $locString['php_ext_warning']; ?></font><?php echo $locString['php_ext_gd_warning']; ?>
            </td>
            <td></td>
        </tr>
    <?php } ?>
    ...
    <tr>
        ...
        <td>
            <p><?php echo $locString['write_rights']; ?><br>
                <small><b><?php echo $locString['note']; ?></b> <?php echo $locString['write_rights_note']; ?></small>
            </p>
        </td>
        <td valign=top>
        ...
        function hello($restart = false)
        {
            ...
            <FORM method=post action="install.php">
                ...
                <P style="font-weight: bold;<?php if ($restart) print "color:red;"; ?>">
                    <input type="checkbox" name="license" value="0" id="i-accept"> <label
                            for="i-accept"><?php echo $locString['license_accept']; ?></label></p>
                ...
                <input type="hidden" value="1" name="nojs" id="nojs"> <input
                        type="hidden" value="1" name="step" id="step"> <input name="edited"
                                                                              type="hidden" id="edited" value="1">
                <input type=hidden name=loginURL
                       value="<?php echo $loginURL; ?>"> <input type=hidden name=dbAdminURL
                                                                value="<?php echo $dbAdminURL; ?>">
                <script language="JavaScript" type="text/javascript">makeHiddenURL('login/', 'loginURL')</script>
    ...
    <div class="main-navigation">
        <div style="margin: 7px;">
            <a class="installer-logo" href="install.php" name="top">
                <span style="font-size:225%;">web<i style="color: rgb(119, 204, 255);">Asyst</i> <em
                            style="color: #777;">Installer</em></span>
            </a>
        </div>
    </div>
    <div class="i-wrapper">
